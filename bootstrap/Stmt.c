...
Value k_stmt;
Value k_blockstmt;
static const char *t_blockstmt_init_1_list[] = { "Statements : List" };
static const char *t_blockstmt_accept_1[] = { "Visitor : Any" };
Value k_expressionstmt;
static const char *t_expressionstmt_init_1_expr[] = { "Expression : Expr" };
static const char *t_expressionstmt_accept_1[] = { "Visitor : Any" };
Value k_varstmt;
static const char *t_varstmt_init_2_token_expr[] = { "Name : Token", "Initializer : Expr" };
static const char *t_varstmt_accept_1[] = { "Visitor : Any" };
Value k_vargroupstmt;
static const char *t_vargroupstmt_init_2_list_expr[] = { "Names : List", "Initializer : Expr" };
static const char *t_vargroupstmt_accept_1[] = { "Visitor : Any" };
Value k_ifstmt;
static const char *t_ifstmt_init_3_expr_stmt_stmt[] = { "Condition : Expr", "ThenBranch : Stmt", "ElseBranch : Stmt" };
static const char *t_ifstmt_accept_1[] = { "Visitor : Any" };
Value k_excepthandler;
static const char *t_excepthandler_init_2_string_stmt[] = { "Name : String", "Body : Stmt" };
Value k_objectstmt;
static const char *t_objectstmt_init_4_token_variableexpr_list_list[] = { "Name : Token", "Superclass : VariableExpr", "Methods : List", "Fields : List" };
static const char *t_objectstmt_accept_1[] = { "Visitor : Any" };
Value k_modulestmt;
static const char *t_modulestmt_init_3_token_list_list[] = { "Name : Token", "Statements : List", "PrivateNames : List" };
static const char *t_modulestmt_accept_1[] = { "Visitor : Any" };
Value k_breakstmt;
...
Value k_raisestmt;
static const char *t_raisestmt_init_2_token_expr[] = { "Keyword : Token", "Value : Expr" };
static const char *t_raisestmt_accept_1[] = { "Visitor : Any" };
Value k_forinstmt;
static const char *t_forinstmt_init_3_token_expr_stmt[] = { "Name : Token", "Iterable : Expr", "Body : Stmt" };
static const char *t_forinstmt_accept_1[] = { "Visitor : Any" };
Value k_whilestmt;
static const char *t_whilestmt_init_2_expr_stmt[] = { "Condition : Expr", "Body : Stmt" };
static const char *t_whilestmt_accept_1[] = { "Visitor : Any" };
Value k_functionstmt;
static const char *t_functionstmt_init_3_token_list_list[] = { "Name : Token", "Params : List", "Body : List" };
static const char *t_functionstmt_accept_1[] = { "Visitor : Any" };
Value k_returnstmt;
static const char *t_returnstmt_init_2_token_expr[] = { "Keyword : Token", "Value : Expr" };
static const char *t_returnstmt_accept_1[] = { "Visitor : Any" };
Value k_enumstmt;
static const char *t_enumstmt_init_2_token_list[] = { "Name : Token", "Members : List" };
static const char *t_enumstmt_accept_1[] = { "Visitor : Any" };
Value k_subrangestmt;
static const char *t_subrangestmt_init_3_token_integer_integer[] = { "Name : Token", "Low : Integer", "High : Integer" };
static const char *t_subrangestmt_accept_1[] = { "Visitor : Any" };
Value k_classstmt;
static const char *t_classstmt_init_4_token_variableexpr_list_list[] = { "Name : Token", "Superclass : VariableExpr", "Methods : List", "Fields : List" };
static const char *t_classstmt_accept_1[] = { "Visitor : Any" };
...
static Value i_breakstmt(Value v_this, Value *args, int32_t count) {
    ...
    alg_set_property(v_this, "Label", alg_widen(alg_string(""), "String"));
    return alg_nil();
}
...
static Value i_labelstmt(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    alg_set_property(v_this, "Name", alg_nil());
...
static Value m_labelstmt_init_2_token_stmt(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_name = alg_widen(args[0], "Token");
    (void)v_name;
    Value v_inner = alg_widen(args[1], "Stmt");
    (void)v_inner;
    (void)(alg_set_property(v_this, "Name", alg_widen(v_name, "Token")));
    (void)(alg_set_property(v_this, "Inner", alg_widen(v_inner, "Stmt")));
    return alg_nil();
}

static Value m_labelstmt_accept_1(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_visitor = args[0];
    (void)v_visitor;
...
static Value i_functionstmt(Value v_this, Value *args, int32_t count) {
    ...
    alg_set_property(v_this, "Symbol", alg_widen(alg_string(""), "String"));
    alg_set_property(v_this, "Library", alg_widen(alg_string(""), "String"));
...
void init_Stmt(void) {
    ...
    alg_class_field(k_breakstmt, "Label");
    ...
    alg_class_field(k_continuestmt, "Label");
    ...
    alg_class_field(k_forinstmt, "Label");
    ...
    alg_class_field(k_whilestmt, "Label");
    ...
    alg_class_field(k_functionstmt, "Symbol");
    alg_class_field(k_functionstmt, "Library");
