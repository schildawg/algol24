...
static const char *t_Environment_RaiseAmbiguousImport_1_String[] = { "String" };
static const char *t_Environment_IsExported_1_String[] = { "String" };
static const char *t_Environment_OwnerOf_1_String[] = { "String" };
...
static Value m_Environment_MarkAmbiguous_2_String_String(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_invoke(alg_property(v_this, "Ambiguous"), "Put", (Value[]){alg_str(v_Name), v_Owners}, 2));
    (void)(alg_invoke(alg_property(v_this, "Values"), "Remove", (Value[]){alg_str(v_Name)}, 1));
    return alg_nil();
}

static Value m_Environment_RaiseAmbiguousImport_1_String(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_Name = args[0];
    (void)v_Name;
            ...
            {
                {
                    ...
                    (void)v_TheModule;
                    if (alg_truthy(alg_invoke(alg_property(v_TheModule, "Values"), "Contains", (Value[]){v_Name}, 1))) {
    ...
    alg_raise(alg_add(alg_add(alg_add(alg_add(alg_string("'"), alg_str(v_Name)), alg_string("' is ambiguous: ")), v_Owners), alg_char_value(46)));
    return alg_nil();
}
...
static Value m_Environment_IsExported_1_String(Value v_this, Value *args, int32_t count) {
    ...
    return alg_invoke(alg_property(v_this, "Exports"), "Contains", (Value[]){v_Name}, 1);
    return alg_nil();
}

static Value m_Environment_OwnerOf_1_String(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_Name = args[0];
    (void)v_Name;
                        ...
                        if (alg_truthy(alg_invoke(v_TheModule, "IsExported", (Value[]){v_Name}, 1))) {
                            {
                                if (alg_truthy((or_0 = alg_not_equal(v_Found, alg_nil()), !alg_truthy(or_0) ? or_0 : alg_not_equal(v_TheModule, v_Found)))) {
                                    (void)(alg_invoke(v_this, "RaiseAmbiguousImport", (Value[]){v_Name}, 1));
                                }
...
static Value m_Environment_Define_2_String(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_Value;
    (void)(alg_invoke(alg_property(v_this, "Values"), "Put", (Value[]){alg_str(v_Name), v_Value}, 2));
    return alg_nil();
}
...
static Value m_Environment_Assign_2_Token(Value v_this, Value *args, int32_t count) {
    ...
    Value v_Value = args[1];
    (void)v_Value;
    if (alg_truthy(alg_invoke(alg_property(v_this, "Values"), "Contains", (Value[]){alg_str(alg_property(v_Name, "Lexeme"))}, 1))) {
        {
            (void)(alg_invoke(alg_property(v_this, "Values"), "Put", (Value[]){alg_str(alg_property(v_Name, "Lexeme")), v_Value}, 2));
            return alg_nil();
        }
    }
    if (alg_truthy(alg_not_equal(alg_property(v_this, "Ambiguous"), alg_nil()))) {
        if (alg_truthy(alg_invoke(alg_property(v_this, "Ambiguous"), "Contains", (Value[]){alg_str(alg_property(v_Name, "Lexeme"))}, 1))) {
            alg_raise(alg_add(alg_add(alg_add(alg_add(alg_string("'"), alg_str(alg_property(v_Name, "Lexeme"))), alg_string("' is ambiguous: ")), alg_str(alg_invoke(alg_property(v_this, "Ambiguous"), "Get", (Value[]){alg_str(alg_property(v_Name, "Lexeme"))}, 1))), alg_char_value(46)));
        }
    }
    Value v_Owner = alg_invoke(v_this, "OwnerOf", (Value[]){alg_str(alg_property(v_Name, "Lexeme"))}, 1);
    (void)v_Owner;
    if (alg_truthy(alg_not_equal(v_Owner, alg_nil()))) {
        {
            (void)(alg_invoke(alg_property((v_Owner), "Values"), "Put", (Value[]){alg_str(alg_property(v_Name, "Lexeme")), v_Value}, 2));
            return alg_nil();
        }
    }
...
static Value m_Environment_Get_1_Token(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_invoke(alg_property(v_this, "Values"), "Contains", (Value[]){alg_str(alg_property(v_Name, "Lexeme"))}, 1))) {
        {
            return alg_invoke(alg_property(v_this, "Values"), "Get", (Value[]){alg_str(alg_property(v_Name, "Lexeme"))}, 1);
        }
    }
    if (alg_truthy(alg_not_equal(alg_property(v_this, "Ambiguous"), alg_nil()))) {
        if (alg_truthy(alg_invoke(alg_property(v_this, "Ambiguous"), "Contains", (Value[]){alg_str(alg_property(v_Name, "Lexeme"))}, 1))) {
    ...
    (void)v_Owner;
    if (alg_truthy(alg_not_equal(v_Owner, alg_nil()))) {
        return alg_invoke(alg_property((v_Owner), "Values"), "Get", (Value[]){alg_str(alg_property(v_Name, "Lexeme"))}, 1);
    }
    if (alg_truthy(alg_not_equal(alg_property(v_this, "Enclosing"), alg_nil()))) {
...
static Value m_Environment_GetAt_2_Integer_String(Value v_this, Value *args, int32_t count) {
    ...
    Value v_Name = args[1];
    (void)v_Name;
    return alg_invoke(alg_property(alg_invoke(v_this, "Ancestor", (Value[]){v_Distance}, 1), "Values"), "Get", (Value[]){v_Name}, 1);
    return alg_nil();
}
...
static Value m_Environment_AssignAt_3_Integer_Token(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_Value;
    (void)(alg_invoke(alg_property(alg_invoke(v_this, "Ancestor", (Value[]){v_Distance}, 1), "Values"), "Put", (Value[]){alg_property(v_Name, "Lexeme"), v_Value}, 2));
    return alg_nil();
}
...
void init_Environment(void) {
    ...
    alg_class_method(k_Environment, "RaiseAmbiguousImport", m_Environment_RaiseAmbiguousImport_1_String, 1, t_Environment_RaiseAmbiguousImport_1_String);
    alg_class_method(k_Environment, "IsExported", m_Environment_IsExported_1_String, 1, t_Environment_IsExported_1_String);
    alg_class_method(k_Environment, "OwnerOf", m_Environment_OwnerOf_1_String, 1, t_Environment_OwnerOf_1_String);
