...
static Value or_1;
static Value or_2;
static const char *t_native_init_2_string_integer[] = { "Name : String", "TheArity : Integer" };
static const char *t_native_call_2[] = { "TheInterpreter : Any", "Arguments : Any" };
static Value or_3;
static Value or_4;
Value fn_parsednumber;
static const char *t_f_parsednumber[] = { "Text : String" };
Value k_interpreter;
static Value or_5;
static Value or_6;
static Value or_7;
...
static const char *t_interpreter_visitgotostmt_1_gotostmt[] = { "TheStmt : GotoStmt" };
...
Value k_jumped;
static const char *t_jumped_init_1_string[] = { "Label : String" };
Value fn_labelat;
static const char *t_f_labelat[] = { "Statements : List", "Named : String" };
Value fn_names;
...
Value f_rendered(Value **cells, Value *args, int32_t count) {
    ...
    {
        Value loop_0 = alg_iterable(v_arguments);
        for (int32_t at_0 = 0; at_0 < alg_iterable_count(loop_0); at_0++) {
            Value v_argument = alg_iterable_at(loop_0, at_0);
            (void)v_argument;
            (void)((v_line = alg_widen(alg_add(v_line, f_stringify(NULL, (Value[]){v_theinterpreter, v_argument}, 2)), "String")));
        }
    }
    return v_line;
    return alg_nil();
    ...
    if (alg_truthy(alg_is(v_value, "ObjCollection"))) {
        {
            ...
            if (alg_truthy(alg_equal(alg_property(v_value, "Kind"), alg_string("Map")))) {
                {
                    Value loop_1 = alg_iterable(alg_invoke(alg_property(v_value, "Pairs"), "Keys", NULL, 0));
                    for (int32_t at_1 = 0; at_1 < alg_iterable_count(loop_1); at_1++) {
                        Value v_key = alg_iterable_at(loop_1, at_1);
                        (void)v_key;
                        {
                ...
                {
                    Value loop_2 = alg_iterable(alg_property(v_value, "Items"));
                    for (int32_t at_2 = 0; at_2 < alg_iterable_count(loop_2); at_2++) {
                        Value v_element = alg_iterable_at(loop_2, at_2);
                        (void)v_element;
                        {
                            if (alg_truthy(alg_not(v_first))) {
                                (void)((v_result = alg_add(v_result, alg_string(", "))));
...
static Value i_native(Value v_this, Value *args, int32_t count) {
...
static Value m_native_init_2_string_integer(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
...
static Value m_native_arity_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    return alg_property(v_this, "TheArity");
    return alg_nil();
}

static Value m_native_tostring_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    return alg_add(alg_add(alg_string("<fn "), alg_property(v_this, "Name")), alg_char_value(62));
    return alg_nil();
}

static Value m_native_call_2(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_theinterpreter = args[0];
    (void)v_theinterpreter;
    Value v_arguments = args[1];
    (void)v_arguments;
    if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("clock")))) {
        return alg_clock();
    } else {
        if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("Length")))) {
            {
            ...
            if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("Copy")))) {
                ...
                if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("Pos")))) {
                    {
                        if (alg_truthy((or_0 = alg_less(alg_property(v_arguments, "Length"), alg_int(2)), alg_truthy(or_0) ? or_0 : alg_greater(alg_property(v_arguments, "Length"), alg_int(3))))) {
                            alg_raise(alg_add(alg_add(alg_string("Expected 2 or 3 arguments but got "), alg_str(alg_property(v_arguments, "Length"))), alg_char_value(46)));
                        }
                        if (alg_truthy(alg_equal(alg_property(v_arguments, "Length"), alg_int(2)))) {
                            return alg_pos(alg_str(alg_subscript_get(v_arguments, alg_int(0))), alg_str(alg_subscript_get(v_arguments, alg_int(1))));
                        }
                        return alg_pos_from(alg_str(alg_subscript_get(v_arguments, alg_int(0))), alg_str(alg_subscript_get(v_arguments, alg_int(1))), alg_subscript_get(v_arguments, alg_int(2)));
                    }
                } else {
                                                        ...
                                                        if (alg_truthy(alg_equal(alg_property(v_arguments, "Length"), alg_int(1)))) {
                                                            {
                                                                ...
                                                                (void)v_from;
                                                                if (alg_truthy((or_1 = alg_not((alg_is(v_from, "ObjCollection"))), alg_truthy(or_1) ? or_1 : alg_not_equal(alg_property(v_from, "Kind"), alg_string("List"))))) {
                                                                    alg_raise(alg_add(alg_add(alg_string("Set expects (List) but got ("), f_typenameof(NULL, (Value[]){v_from}, 1)), alg_string(").")));
                                                                }
                                                                {
                                                                    Value loop_3 = alg_iterable(alg_property(v_from, "Items"));
                                                                    for (int32_t at_3 = 0; at_3 < alg_iterable_count(loop_3); at_3++) {
                                                                        Value v_item = alg_iterable_at(loop_3, at_3);
                                                                        (void)v_item;
                                                                        (void)(alg_invoke(v_theset, "Invoke", (Value[]){alg_string("add"), alg_list_keep(alg_list(), v_item)}, 2));
                                                                    }
                                                                }
                                                            }
                                                        }
                                                                                        ...
                                                                                        if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("Mod")))) {
                                                                                            ...
                                                                                            if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("TextFile")))) {
                                                                                                ...
                                                                                                if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("FileExists")))) {
                                                                                                    ...
                                                                                                    if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("MkDir")))) {
                                                                                                        return alg_mkdir(alg_str(alg_subscript_get(v_arguments, alg_int(0))));
                                                                                                    } else {
                                                                                                        if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("RmDir")))) {
                                                                                                            return alg_rmdir(alg_str(alg_subscript_get(v_arguments, alg_int(0))));
                                                                                                        } else {
                                                                                                            if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("ChDir")))) {
                                                                                                                return alg_chdir(alg_str(alg_subscript_get(v_arguments, alg_int(0))));
                                                                                                            } else {
                                                                                                                if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("GetDir")))) {
                                                                                                                    return alg_getdir();
                                                                                                                } else {
                                                                                                                            ...
                                                                                                                            if (alg_truthy(alg_equal(alg_property(v_this, "Name"), alg_string("ParamStr")))) {
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    (void)v_at;
                                                                                                                                    if (alg_truthy((or_2 = alg_less(v_at, alg_int(0)), alg_truthy(or_2) ? or_2 : alg_greater_equal(v_at, alg_property((alg_declared(d_programarguments, "ProgramArguments"), v_programarguments), "Length"))))) {
                                                                                                                                        return alg_string("");
                                                                                                                                    }
    ...
    alg_raise(alg_add(alg_add(alg_string("Undefined built-in '"), alg_property(v_this, "Name")), alg_string("'.")));
    return alg_nil();
}
...
Value f_parsednumber(Value **cells, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_3 = alg_greater(alg_text_length(v_digits), alg_int(0)), !alg_truthy(or_3) ? or_3 : alg_equal(alg_subscript_get(v_digits, alg_int(0)), alg_char_value(45))))) {
        {
        ...
        for (; alg_truthy(alg_less(v_i, alg_text_length(v_digits))); (v_i = alg_add(v_i, alg_int(1)))) {
            {
                ...
                (void)v_c;
                if (alg_truthy((or_4 = alg_less(v_c, alg_char_value(48)), alg_truthy(or_4) ? or_4 : alg_greater(v_c, alg_char_value(57))))) {
                    return v_asdouble;
                }
...
static Value m_interpreter_init_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("clock"), alg_new(k_native, (Value[]){alg_string("clock"), alg_int(0)}, 2)}, 2));
    ...
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Pos"), alg_new(k_native, (Value[]){alg_string("Pos"), alg_negate(alg_int(1))}, 2)}, 2));
    ...
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Map"), alg_new(k_native, (Value[]){alg_string("Map"), alg_int(0)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Set"), alg_new(k_native, (Value[]){alg_string("Set"), alg_negate(alg_int(1))}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Stack"), alg_new(k_native, (Value[]){alg_string("Stack"), alg_int(0)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Halt"), alg_new(k_native, (Value[]){alg_string("Halt"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Ord"), alg_new(k_native, (Value[]){alg_string("Ord"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Succ"), alg_new(k_native, (Value[]){alg_string("Succ"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Pred"), alg_new(k_native, (Value[]){alg_string("Pred"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Mod"), alg_new(k_native, (Value[]){alg_string("Mod"), alg_int(2)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Foreign"), alg_new(k_native, (Value[]){alg_string("Foreign"), alg_int(5)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Val"), alg_new(k_native, (Value[]){alg_string("Val"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Char"), alg_new(k_native, (Value[]){alg_string("Char"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Write"), alg_new(k_native, (Value[]){alg_string("Write"), alg_negate(alg_int(1))}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("WriteLn"), alg_new(k_native, (Value[]){alg_string("WriteLn"), alg_negate(alg_int(1))}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Buffer"), alg_new(k_native, (Value[]){alg_string("Buffer"), alg_negate(alg_int(1))}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("TextFile"), alg_new(k_native, (Value[]){alg_string("TextFile"), alg_int(0)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("FileExists"), alg_new(k_native, (Value[]){alg_string("FileExists"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("MkDir"), alg_new(k_native, (Value[]){alg_string("MkDir"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("RmDir"), alg_new(k_native, (Value[]){alg_string("RmDir"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("ChDir"), alg_new(k_native, (Value[]){alg_string("ChDir"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("GetDir"), alg_new(k_native, (Value[]){alg_string("GetDir"), alg_int(0)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("ParamCount"), alg_new(k_native, (Value[]){alg_string("ParamCount"), alg_int(0)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("ParamStr"), alg_new(k_native, (Value[]){alg_string("ParamStr"), alg_int(1)}, 2)}, 2));
    return alg_nil();
}
...
static Value m_interpreter_interpret_1_list(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_statements;
    {
        ...
        if (ALG_SETJMP(frame_4.jump) == 0) {
                ...
                while (alg_truthy(alg_less(v_i, alg_property(v_statements, "Length")))) {
                    {
                        ...
                        }
                        {
                            ...
                            if (ALG_SETJMP(frame_5.jump) == 0) {
                                ...
                                static const char *names_5[] = {"Jumped"};
                                int32_t which_5 = alg_handler(frame_5.raised, names_5, 1);
                                if (which_5 == 0) {
                                    {
                                        volatile Value v_g = frame_5.raised;
                                        (void)v_g;
                                        {
                                            volatile Value v_at = f_labelat(NULL, (Value[]){v_statements, alg_property(v_g, "Label")}, 2);
                                            (void)v_at;
                                            if (alg_truthy(alg_less(v_at, alg_int(0)))) {
                                                alg_raise(v_g);
                                            }
                                            (void)((v_i = alg_widen(v_at, "Integer")));
                                        }
                                    }
                                }
                                else {
            ...
            static const char *names_4[] = {"Raised"};
...
static Value m_interpreter_hoisttests_11_list_list_map_boolean_environment_map_string_list_map_set_boolean(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_collect;
    {
        Value loop_6 = alg_iterable(v_statements);
        for (int32_t at_6 = 0; at_6 < alg_iterable_count(loop_6); at_6++) {
            Value v_thestmt = alg_iterable_at(loop_6, at_6);
            (void)v_thestmt;
            {
                    ...
                    if (alg_truthy(alg_is(v_thestmt, "FunctionStmt"))) {
                        {
                            ...
                            if (alg_truthy((or_5 = alg_not_equal(alg_property(alg_property(v_thestmt, "Name"), "Literal"), alg_nil()), !alg_truthy(or_5) ? or_5 : v_collect))) {
                                {
                        ...
                        if (alg_truthy((or_10 = v_define, !alg_truthy(or_10) ? or_10 : ((or_9 = (or_8 = (or_7 = (or_6 = alg_is(v_thestmt, "ClassStmt"), alg_truthy(or_6) ? or_6 : alg_is(v_thestmt, "ObjectStmt")), alg_truthy(or_7) ? or_7 : alg_is(v_thestmt, "EnumStmt")), alg_truthy(or_8) ? or_8 : alg_is(v_thestmt, "VarGroupStmt")), alg_truthy(or_9) ? or_9 : alg_is(v_thestmt, "VarStmt")))))) {
                            (void)(alg_invoke(v_this, "Execute", (Value[]){v_thestmt}, 1));
                        }
                    }
                }
...
static Value m_interpreter_runtests_2_list_string(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_invoke(v_this, "RegisterRoot", NULL, 0));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("AssertTrue"), alg_new(k_native, (Value[]){alg_string("AssertTrue"), alg_int(1)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("AssertEqual"), alg_new(k_native, (Value[]){alg_string("AssertEqual"), alg_int(2)}, 2)}, 2));
    (void)(alg_invoke(alg_property(v_this, "Builtins"), "Define", (Value[]){alg_string("Fail"), alg_new(k_native, (Value[]){alg_string("Fail"), alg_int(1)}, 2)}, 2));
    ...
    (void)v_ordered;
    {
        volatile Value loop_7 = alg_iterable(v_files);
        for (volatile int32_t at_7 = 0; at_7 < alg_iterable_count(loop_7); at_7++) {
            volatile Value v_file = alg_iterable_at(loop_7, at_7);
            (void)v_file;
            {
                volatile Value v_group = alg_cast(alg_invoke(v_byfile, "Get", (Value[]){v_file}, 1), "List");
                (void)v_group;
                (void)(alg_invoke(v_group, "Sort", NULL, 0));
                (void)(alg_invoke(v_ordered, "Add", (Value[]){v_file}, 1));
                {
                    volatile Value loop_8 = alg_iterable(v_group);
                    for (volatile int32_t at_8 = 0; at_8 < alg_iterable_count(loop_8); at_8++) {
                        volatile Value v_each = alg_iterable_at(loop_8, at_8);
                        (void)v_each;
                        (void)(alg_invoke(v_ordered, "Add", (Value[]){v_each}, 1));
                    }
                }
            }
        }
                ...
                } else {
                    {
                        ...
                        (void)v_name;
                        {
                            ...
                            if (ALG_SETJMP(frame_9.jump) == 0) {
                                ...
                                static const char *names_9[] = {"String", "Raised"};
                                int32_t which_9 = alg_handler(frame_9.raised, names_9, 2);
                                if (which_9 == 0) {
                                    {
...
static Value m_interpreter_visitcollectionexpr_1_collectionexpr(Value v_this, Value *args, int32_t count) {
    ...
    {
        Value loop_10 = alg_iterable(alg_property(v_theexpr, "Values"));
        for (int32_t at_10 = 0; at_10 < alg_iterable_count(loop_10); at_10++) {
            Value v_value = alg_iterable_at(loop_10, at_10);
            (void)v_value;
            (void)(alg_invoke(alg_property(v_result, "Items"), "Add", (Value[]){alg_invoke(v_this, "Evaluate", (Value[]){v_value}, 1)}, 1));
        }
    }
    return v_result;
    return alg_nil();
...
static Value m_interpreter_istext_1(Value v_this, Value *args, int32_t count) {
    ...
    Value v_obj = args[0];
    (void)v_obj;
    return (or_11 = alg_is(v_obj, "String"), alg_truthy(or_11) ? or_11 : alg_is(v_obj, "Char"));
    return alg_nil();
}
...
static Value m_interpreter_insubrange_2_string(Value v_this, Value *args, int32_t count) {
    ...
    return (or_12 = alg_greater_equal(v_value, alg_subscript_get((alg_declared(d_subrangeVlows, "SUBRANGE_LOWS"), v_subrangeVlows), v_at)), !alg_truthy(or_12) ? or_12 : alg_less_equal(v_value, alg_subscript_get((alg_declared(d_subrangeVhighs, "SUBRANGE_HIGHS"), v_subrangeVhighs), v_at)));
    return alg_nil();
}
...
static Value m_interpreter_visitvariableexpr_1_variableexpr(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_theexpr;
    {
        ...
        if (ALG_SETJMP(frame_11.jump) == 0) {
            {
                volatile Value ret_12 = alg_invoke(v_this, "LookupVariable", (Value[]){alg_property(v_theexpr, "Name"), v_theexpr}, 2);
                alg_pop_frame();
                return ret_12;
            }
            alg_pop_frame();
        ...
        if (ALG_SETJMP(frame_13.jump) == 0) {
            {
                ...
                volatile Value ret_14 = alg_invoke(v_obj, "Get", (Value[]){v_name}, 1);
                alg_pop_frame();
                return ret_14;
            }
            alg_pop_frame();
            ...
            static const char *names_13[] = {"String"};
...
static Value m_interpreter_setthisfield_3_token_string(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_obj;
    {
        ...
        if (ALG_SETJMP(frame_15.jump) == 0) {
            ...
            static const char *names_15[] = {"String"};
...
static Value m_interpreter_lookupvariable_2_token_expr(Value v_this, Value *args, int32_t count) {
    ...
    }
    {
        ...
        if (ALG_SETJMP(frame_16.jump) == 0) {
            {
                volatile Value ret_17 = alg_invoke(alg_property(v_this, "Env"), "Get", (Value[]){v_name}, 1);
                alg_pop_frame();
                return ret_17;
            }
            alg_pop_frame();
...
static Value m_interpreter_suggestunit_2_token_string(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_units;
    {
        Value loop_18 = alg_iterable(v_units);
        for (int32_t at_18 = 0; at_18 < alg_iterable_count(loop_18); at_18++) {
            Value v_theunit = alg_iterable_at(loop_18, at_18);
            (void)v_theunit;
            {
                Value v_moduleenv = alg_cast(alg_invoke(alg_property(v_this, "UnitsByName"), "Get", (Value[]){v_theunit}, 1), "Environment");
                (void)v_moduleenv;
                if (alg_truthy((or_13 = alg_not_equal(alg_property(v_moduleenv, "Exports"), alg_nil()), !alg_truthy(or_13) ? or_13 : alg_invoke(alg_property(v_moduleenv, "Exports"), "Contains", (Value[]){f_foldcase(NULL, (Value[]){alg_property(v_name, "Lexeme")}, 1)}, 1)))) {
    ...
    if (alg_truthy((or_14 = alg_not_equal(alg_property(v_this, "Env"), alg_property(v_this, "Globals")), !alg_truthy(or_14) ? or_14 : alg_invoke(alg_property(alg_property(v_this, "Globals"), "Values"), "Contains", (Value[]){f_foldcase(NULL, (Value[]){alg_property(v_name, "Lexeme")}, 1)}, 1)))) {
...
static Value m_interpreter_integerdivide_2(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_right;
    if (alg_truthy((or_15 = alg_not((alg_is(v_left, "Integer"))), alg_truthy(or_15) ? or_15 : alg_not((alg_is(v_right, "Integer")))))) {
...
static Value m_interpreter_arithmetic_1(Value v_this, Value *args, int32_t count) {
    ...
    Value v_op = args[0];
    (void)v_op;
    return (or_19 = (or_18 = (or_17 = (or_16 = alg_equal(v_op, e_tokentype_tokenVplus), alg_truthy(or_16) ? or_16 : alg_equal(v_op, e_tokentype_tokenVminus)), alg_truthy(or_17) ? or_17 : alg_equal(v_op, e_tokentype_tokenVstar)), alg_truthy(or_18) ? or_18 : alg_equal(v_op, e_tokentype_tokenVslash)), alg_truthy(or_19) ? or_19 : alg_equal(v_op, e_tokentype_tokenVdiv));
    return alg_nil();
}
...
static Value m_interpreter_orders_1(Value v_this, Value *args, int32_t count) {
    ...
    Value v_op = args[0];
    (void)v_op;
    return (or_22 = (or_21 = (or_20 = alg_equal(v_op, e_tokentype_tokenVless), alg_truthy(or_20) ? or_20 : alg_equal(v_op, e_tokentype_tokenVlessVequal)), alg_truthy(or_21) ? or_21 : alg_equal(v_op, e_tokentype_tokenVgreater)), alg_truthy(or_22) ? or_22 : alg_equal(v_op, e_tokentype_tokenVgreaterVequal));
    return alg_nil();
}
...
static Value m_interpreter_visitbinary_1_binaryexpr(Value v_this, Value *args, int32_t count) {
    ...
    (void)((v_left = alg_invoke(v_this, "Evaluate", (Value[]){alg_property(v_theexpr, "Left")}, 1)));
    (void)((v_right = alg_invoke(v_this, "Evaluate", (Value[]){alg_property(v_theexpr, "Right")}, 1)));
    if (alg_truthy((or_23 = alg_is(v_left, "ObjInstance"), !alg_truthy(or_23) ? or_23 : alg_invoke(v_this, "Arithmetic", (Value[]){alg_property(alg_property(v_theexpr, "Op"), "TypeOfToken")}, 1)))) {
        {
    ...
    if (alg_truthy((or_24 = alg_is(v_left, "ObjInstance"), !alg_truthy(or_24) ? or_24 : alg_invoke(v_this, "Orders", (Value[]){alg_property(alg_property(v_theexpr, "Op"), "TypeOfToken")}, 1)))) {
        {
            Value v_ordering = alg_invoke(alg_property(v_left, "Klass"), "MethodOfArity", (Value[]){alg_string("compare"), alg_int(1)}, 2);
            (void)v_ordering;
            if (alg_truthy(alg_not_equal(v_ordering, alg_nil()))) {
                {
                    (void)((v_left = alg_invoke(alg_invoke(v_ordering, "Bind", (Value[]){v_left}, 1), "Call", (Value[]){v_this, alg_list_keep(alg_list(), v_right)}, 2)));
                    (void)((v_right = alg_int(0)));
                    if (alg_truthy(alg_not((alg_is(v_left, "Integer"))))) {
                        alg_raise(alg_string("Compare must answer an Integer."));
                    }
                }
            }
        }
...
static Value m_interpreter_arranged_3_list_list(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_is(v_callee, "ObjOverloads"))) {
        {
            {
                Value loop_19 = alg_iterable(alg_property(v_callee, "Candidates"));
                for (int32_t at_19 = 0; at_19 < alg_iterable_count(loop_19); at_19++) {
                    Value v_candidate = alg_iterable_at(loop_19, at_19);
                    (void)v_candidate;
                    {
                        Value v_fitted = alg_invoke(v_candidate, "Arrange", (Value[]){v_arguments, v_names}, 2);
                        (void)v_fitted;
...
static Value m_interpreter_visitcall_1_callexpr(Value v_this, Value *args, int32_t count) {
    ...
    {
        Value loop_20 = alg_iterable(alg_property(v_theexpr, "Arguments"));
        for (int32_t at_20 = 0; at_20 < alg_iterable_count(loop_20); at_20++) {
            Value v_argument = alg_iterable_at(loop_20, at_20);
            (void)v_argument;
            {
                (void)(alg_invoke(v_arguments, "Add", (Value[]){alg_invoke(v_this, "Evaluate", (Value[]){v_argument}, 1)}, 1));
            }
        }
    }
    ...
    if (alg_truthy(alg_is(v_callee, "ObjFunction"))) {
        {
            if (alg_truthy(alg_not_equal(alg_property(v_callee, "Owner"), alg_nil()))) {
                ...
                if (alg_truthy((or_25 = alg_not(alg_invoke(v_callee, "Fits", (Value[]){v_arguments, alg_bool(true)}, 2)), !alg_truthy(or_25) ? or_25 : alg_not(alg_invoke(v_callee, "Absorbs", (Value[]){v_arguments}, 1))))) {
                    {
                        if (alg_truthy((or_26 = alg_not(alg_invoke(v_callee, "Variadic", NULL, 0)), !alg_truthy(or_26) ? or_26 : alg_not_equal(alg_property(v_arguments, "Length"), alg_invoke(v_callee, "Arity", NULL, 0))))) {
    ...
    if (alg_truthy((or_28 = (or_27 = alg_not(v_gathering), !alg_truthy(or_27) ? or_27 : alg_greater_equal(alg_invoke(v_callee, "Arity", NULL, 0), alg_int(0))), !alg_truthy(or_28) ? or_28 : alg_not_equal(alg_property(v_arguments, "Length"), alg_invoke(v_callee, "Arity", NULL, 0))))) {
        {
            alg_raise(alg_add(alg_add(alg_add(alg_add(alg_string("Expected "), alg_invoke(v_callee, "Arity", NULL, 0)), alg_string(" arguments but got ")), alg_property(v_arguments, "Length")), alg_char_value(46)));
        }
    }
...
static Value m_interpreter_assignqualified_3_string_token(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_29 = alg_equal(alg_property(v_moduleenv, "Exports"), alg_nil()), alg_truthy(or_29) ? or_29 : alg_not(alg_invoke(alg_property(v_moduleenv, "Exports"), "Contains", (Value[]){f_foldcase(NULL, (Value[]){alg_property(v_name, "Lexeme")}, 1)}, 1))))) {
        alg_raise(alg_add(alg_add(alg_add(alg_add(alg_string("Undefined name '"), alg_str(alg_property(v_name, "Lexeme"))), alg_string("' in unit '")), v_unit), alg_string("'.")));
    }
...
static Value m_interpreter_qualified_2_string_token(Value v_this, Value *args, int32_t count) {
    ...
    (void)((v_moduleenv = alg_widen(alg_cast(alg_invoke(alg_property(v_this, "UnitsByName"), "Get", (Value[]){f_foldcase(NULL, (Value[]){v_unit}, 1)}, 1), "Environment"), "Environment")));
    if (alg_truthy((or_30 = alg_equal(alg_property(v_moduleenv, "Exports"), alg_nil()), alg_truthy(or_30) ? or_30 : alg_not(alg_invoke(alg_property(v_moduleenv, "Exports"), "Contains", (Value[]){f_foldcase(NULL, (Value[]){alg_property(v_name, "Lexeme")}, 1)}, 1))))) {
        alg_raise(alg_add(alg_add(alg_add(alg_add(alg_string("Undefined name '"), alg_str(alg_property(v_name, "Lexeme"))), alg_string("' in unit '")), v_unit), alg_string("'.")));
    }
...
static Value m_interpreter_visitgetexpr_1_getexpr(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_31 = alg_is(v_obj, "Integer"), alg_truthy(or_31) ? or_31 : alg_is(v_obj, "Double")))) {
        {
    ...
    if (alg_truthy(alg_not(((or_36 = (or_35 = (or_34 = (or_33 = (or_32 = alg_is(v_obj, "ObjInstance"), alg_truthy(or_32) ? or_32 : alg_is(v_obj, "ObjEnumType")), alg_truthy(or_33) ? or_33 : alg_is(v_obj, "ObjEnum")), alg_truthy(or_34) ? or_34 : alg_is(v_obj, "ObjCollection")), alg_truthy(or_35) ? or_35 : alg_is(v_obj, "ObjFile")), alg_truthy(or_36) ? or_36 : alg_is(v_obj, "ObjBuffer")))))) {
        {
    ...
    if (alg_truthy(alg_is(v_obj, "ObjInstance"))) {
        {
            ...
            (void)v_member;
            if (alg_truthy((or_38 = (or_37 = alg_not_equal(v_member, alg_nil()), !alg_truthy(or_37) ? or_37 : alg_property(alg_property(v_member, "Declaration"), "IsProperty")), !alg_truthy(or_38) ? or_38 : alg_not(alg_invoke(alg_property(v_obj, "Fields"), "Contains", (Value[]){f_foldcase(NULL, (Value[]){alg_property(alg_property(v_theexpr, "Name"), "Lexeme")}, 1)}, 1))))) {
...
static Value m_interpreter_classnameof_1(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_obj;
    {
        ...
        if (ALG_SETJMP(frame_21.jump) == 0) {
            {
                volatile Value ret_22 = alg_property(v_obj, "ClassName");
                alg_pop_frame();
                return ret_22;
            }
            alg_pop_frame();
...
static Value m_interpreter_istruthy_1(Value v_this, Value *args, int32_t count) {
    ...
    Value v_obj = args[0];
    (void)v_obj;
    if (alg_truthy((or_39 = alg_equal(v_obj, alg_nil()), alg_truthy(or_39) ? or_39 : alg_equal(v_obj, alg_bool(false))))) {
        return alg_bool(false);
    }
...
static Value m_interpreter_isequal_2(Value v_this, Value *args, int32_t count) {
    ...
    Value v_b = args[1];
    (void)v_b;
    if (alg_truthy((or_40 = alg_equal(v_a, alg_nil()), !alg_truthy(or_40) ? or_40 : alg_equal(v_b, alg_nil())))) {
        return alg_bool(true);
    }
...
static Value m_interpreter_widen_2_string(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_declared;
    if (alg_truthy((or_41 = alg_equal(v_declared, alg_string("")), alg_truthy(or_41) ? or_41 : alg_equal(v_value, alg_nil())))) {
        return v_value;
    }
    ...
    if (alg_truthy((or_42 = alg_equal(v_declared, alg_string("Double")), !alg_truthy(or_42) ? or_42 : alg_is(v_value, "Integer")))) {
        return alg_multiply(v_value, alg_double(1.0));
    }
    if (alg_truthy((or_43 = alg_equal(v_declared, alg_string("String")), !alg_truthy(or_43) ? or_43 : alg_is(v_value, "Char")))) {
        return alg_str(v_value);
    }
    return v_value;
    return alg_nil();
...
static Value m_interpreter_evaluate_1_expr(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_44 = alg_not_equal(alg_property(v_theexpr, "Cast"), alg_string("")), !alg_truthy(or_44) ? or_44 : alg_not_equal(v_value, alg_nil())))) {
        {
                ...
                while (alg_truthy(alg_less(v_i, alg_property(v_statements, "Length")))) {
                    {
                        {
                            AlgFrame frame_24;
                            alg_push_frame(&frame_24);
                            if (ALG_SETJMP(frame_24.jump) == 0) {
                                {
                                    (void)(alg_invoke(v_this, "Execute", (Value[]){alg_subscript_get(v_statements, v_i)}, 1));
                                ...
                                static const char *names_24[] = {"Jumped"};
                                int32_t which_24 = alg_handler(frame_24.raised, names_24, 1);
                                if (which_24 == 0) {
                                    {
                                        volatile Value v_g = frame_24.raised;
                                        (void)v_g;
                                        {
                                            volatile Value v_at = f_labelat(NULL, (Value[]){v_statements, alg_property(v_g, "Label")}, 2);
                                            (void)v_at;
...
static Value m_interpreter_visitclassstmt_1_classstmt(Value v_this, Value *args, int32_t count) {
    ...
    {
        Value loop_25 = alg_iterable(alg_property(v_thestmt, "Methods"));
        for (int32_t at_25 = 0; at_25 < alg_iterable_count(loop_25); at_25++) {
            Value v_method = alg_iterable_at(loop_25, at_25);
            (void)v_method;
            {
    ...
    }
    {
        ...
        for (int32_t at_26 = 0; at_26 < alg_iterable_count(loop_26); at_26++) {
            Value v_name = alg_iterable_at(loop_26, at_26);
            (void)v_name;
            {
                Value loop_27 = alg_iterable(alg_invoke(v_methods, "Get", (Value[]){v_name}, 1));
                for (int32_t at_27 = 0; at_27 < alg_iterable_count(loop_27); at_27++) {
                    Value v_each = alg_iterable_at(loop_27, at_27);
                    (void)v_each;
                    (void)(alg_set_property(v_each, "Owner", v_klass));
                }
            }
        }
    }
...
static Value m_interpreter_visitobjectstmt_1_objectstmt(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_hasid;
    {
        Value loop_28 = alg_iterable(alg_property(v_thestmt, "Fields"));
        for (int32_t at_28 = 0; at_28 < alg_iterable_count(loop_28); at_28++) {
            Value v_field = alg_iterable_at(loop_28, at_28);
            (void)v_field;
            if (alg_truthy(alg_equal(f_foldcase(NULL, (Value[]){alg_property(alg_property(v_field, "Name"), "Lexeme")}, 1), alg_string("id")))) {
...
static Value m_interpreter_visitenumstmt_1_enumstmt(Value v_this, Value *args, int32_t count) {
    ...
    {
        Value loop_29 = alg_iterable(alg_property(v_thestmt, "Members"));
        for (int32_t at_29 = 0; at_29 < alg_iterable_count(loop_29); at_29++) {
            Value v_themember = alg_iterable_at(loop_29, at_29);
            (void)v_themember;
            {
                Value v_membername = alg_str(alg_property(v_themember, "Lexeme"));
                (void)v_membername;
    ...
    if (alg_truthy(alg_invoke(alg_property(alg_property(v_this, "Env"), "Values"), "Contains", (Value[]){v_key}, 1))) {
        {
            ...
            (void)v_existing;
            if (alg_truthy((or_45 = alg_not((alg_is(v_existing, "ObjFunction"))), !alg_truthy(or_45) ? or_45 : alg_not((alg_is(v_existing, "ObjOverloads")))))) {
            ...
            {
                Value loop_30 = alg_iterable(alg_property(v_overloads, "Candidates"));
                for (int32_t at_30 = 0; at_30 < alg_iterable_count(loop_30); at_30++) {
                    Value v_candidate = alg_iterable_at(loop_30, at_30);
                    (void)v_candidate;
                    if (alg_truthy(f_samesignature(NULL, (Value[]){alg_property(v_candidate, "Declaration"), v_thestmt}, 2))) {
                        alg_raise(alg_add(alg_add(alg_char_value(39), alg_str(alg_property(alg_property(v_thestmt, "Name"), "Lexeme"))), alg_string("' is already defined.")));
                    }
                }
            }
...
static Value m_interpreter_visitwhilestmt_1_whilestmt(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_stmt;
    {
        ...
        if (ALG_SETJMP(frame_31.jump) == 0) {
                    ...
                    {
                        {
                            ...
                            if (ALG_SETJMP(frame_32.jump) == 0) {
                                ...
                                static const char *names_32[] = {"Continued"};
                                int32_t which_32 = alg_handler(frame_32.raised, names_32, 1);
                                if (which_32 == 0) {
                                    {
                                        volatile Value v_c = frame_32.raised;
                                        (void)v_c;
            ...
            static const char *names_31[] = {"Broke"};
            int32_t which_31 = alg_handler(frame_31.raised, names_31, 1);
            if (which_31 == 0) {
                {
                    volatile Value v_e = frame_31.raised;
                    (void)v_e;
...
static Value m_interpreter_iscallable_1(Value v_this, Value *args, int32_t count) {
    ...
    {
        AlgFrame frame_33;
        alg_push_frame(&frame_33);
        if (ALG_SETJMP(frame_33.jump) == 0) {
            {
                volatile Value v_thearity = alg_property(v_value, "Arity");
                (void)v_thearity;
                volatile Value ret_34 = alg_bool(true);
                alg_pop_frame();
                return ret_34;
            }
            alg_pop_frame();
            ...
            static const char *names_33[] = {"String"};
            int32_t which_33 = alg_handler(frame_33.raised, names_33, 1);
            if (which_33 == 0) {
                {
                    volatile Value v_e = frame_33.raised;
                    (void)v_e;
                    return alg_bool(false);
                }
            }
            else {
                alg_raise(frame_33.raised);
            }
        }
    }
    return alg_nil();
    ...
    if (alg_truthy(alg_is(v_target, "ObjCollection"))) {
        {
            ...
            {
                Value loop_35 = alg_iterable(alg_property(v_target, "Items"));
                for (int32_t at_35 = 0; at_35 < alg_iterable_count(loop_35); at_35++) {
                    Value v_item = alg_iterable_at(loop_35, at_35);
                    (void)v_item;
                    (void)(alg_invoke(v_result, "Add", (Value[]){v_item}, 1));
                }
            }
            return v_result;
        }
...
static Value m_interpreter_visitforinstmt_1_forinstmt(Value v_this, Value *args, int32_t count) {
    ...
    {
        AlgFrame frame_36;
        alg_push_frame(&frame_36);
        if (ALG_SETJMP(frame_36.jump) == 0) {
            {
                {
                    volatile Value loop_37 = alg_iterable(v_elements);
                    for (volatile int32_t at_37 = 0; at_37 < alg_iterable_count(loop_37); at_37++) {
                        volatile Value v_element = alg_iterable_at(loop_37, at_37);
                        (void)v_element;
                        {
                            ...
                            (void)(alg_invoke(v_scope, "Define", (Value[]){alg_property(alg_property(v_thestmt, "Name"), "Lexeme"), v_element}, 2));
                            {
                                AlgFrame frame_38;
                                alg_push_frame(&frame_38);
                                if (ALG_SETJMP(frame_38.jump) == 0) {
                                    {
                                    ...
                                    static const char *names_38[] = {"Continued"};
                                    int32_t which_38 = alg_handler(frame_38.raised, names_38, 1);
                                    if (which_38 == 0) {
                                        {
                                            volatile Value v_c = frame_38.raised;
                                            (void)v_c;
            ...
            static const char *names_36[] = {"Broke"};
            int32_t which_36 = alg_handler(frame_36.raised, names_36, 1);
            if (which_36 == 0) {
                {
                    volatile Value v_e = frame_36.raised;
                    (void)v_e;
...
static Value m_interpreter_visitgotostmt_1_gotostmt(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_thestmt = alg_widen(args[0], "GotoStmt");
    (void)v_thestmt;
    alg_raise(alg_new(k_jumped, (Value[]){alg_property(v_thestmt, "Label")}, 1));
    return alg_nil();
}
...
static Value m_interpreter_visitmodulestmt_1_modulestmt(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_hidden;
    {
        Value loop_39 = alg_iterable(alg_property(v_thestmt, "PrivateNames"));
        for (int32_t at_39 = 0; at_39 < alg_iterable_count(loop_39); at_39++) {
            Value v_privatename = alg_iterable_at(loop_39, at_39);
            (void)v_privatename;
            (void)(alg_invoke(v_hidden, "Add", (Value[]){f_foldcase(NULL, (Value[]){v_privatename}, 1)}, 1));
        }
    }
    Value v_names = alg_invoke(alg_property(v_moduleenv, "Values"), "Keys", NULL, 0);
    (void)v_names;
    {
        Value loop_40 = alg_iterable(v_names);
        for (int32_t at_40 = 0; at_40 < alg_iterable_count(loop_40); at_40++) {
            Value v_thename = alg_iterable_at(loop_40, at_40);
            (void)v_thename;
            {
    ...
    {
        Value loop_41 = alg_iterable(v_exported);
        for (int32_t at_41 = 0; at_41 < alg_iterable_count(loop_41); at_41++) {
            Value v_each = alg_iterable_at(loop_41, at_41);
            (void)v_each;
            (void)(alg_invoke(alg_property(v_moduleenv, "Exports"), "Add", (Value[]){v_each}, 1));
        }
    }
...
static Value m_interpreter_handle_3_trystmt(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_46 = alg_equal(v_handler, alg_nil()), !alg_truthy(or_46) ? or_46 : alg_invoke(alg_property(v_thestmt, "Handlers"), "Contains", (Value[]){alg_string("default")}, 1)))) {
...
static Value m_interpreter_visittrystmt_1_trystmt(Value v_this, Value *args, int32_t count) {
    ...
    {
        AlgFrame frame_42;
        alg_push_frame(&frame_42);
        if (ALG_SETJMP(frame_42.jump) == 0) {
            {
            ...
            static const char *names_42[] = {"Return", "Raised", "String"};
            int32_t which_42 = alg_handler(frame_42.raised, names_42, 3);
            if (which_42 == 0) {
                {
                    volatile Value v_e = frame_42.raised;
                    (void)v_e;
                    alg_raise(v_e);
                }
            }
...
static Value m_interpreter_visitvargroupstmt_1_vargroupstmt(Value v_this, Value *args, int32_t count) {
    ...
    {
        Value loop_43 = alg_iterable(alg_property(v_thestmt, "Names"));
        for (int32_t at_43 = 0; at_43 < alg_iterable_count(loop_43); at_43++) {
            Value v_thename = alg_iterable_at(loop_43, at_43);
            (void)v_thename;
            (void)(alg_invoke(alg_property(v_this, "Env"), "Define", (Value[]){alg_property(v_thename, "Lexeme"), v_value}, 2));
        }
    }
    return alg_nil();
}
    ...
    if (alg_truthy(alg_not_equal(v_distance, alg_nil()))) {
        {
            {
                AlgFrame frame_44;
                alg_push_frame(&frame_44);
                if (ALG_SETJMP(frame_44.jump) == 0) {
                    {
                    ...
                    static const char *names_44[] = {"String"};
                    int32_t which_44 = alg_handler(frame_44.raised, names_44, 1);
                    if (which_44 == 0) {
                        {
                            volatile Value v_e = frame_44.raised;
                            (void)v_e;
                            (void)(alg_invoke(v_this, "SetThisField", (Value[]){alg_property(v_expr, "Name"), v_value, v_e}, 3));
                        }
                    }
                    else {
                        alg_raise(frame_44.raised);
                    }
                }
            }
        }
    } else {
        {
            {
                AlgFrame frame_45;
                alg_push_frame(&frame_45);
                if (ALG_SETJMP(frame_45.jump) == 0) {
                    {
                    ...
                    static const char *names_45[] = {"String"};
                    int32_t which_45 = alg_handler(frame_45.raised, names_45, 1);
                    if (which_45 == 0) {
                        {
                            volatile Value v_e = frame_45.raised;
                            (void)v_e;
                            (void)(alg_invoke(v_this, "SetThisField", (Value[]){alg_property(v_expr, "Name"), v_value, v_e}, 3));
                        }
                    }
                    else {
                        alg_raise(frame_45.raised);
                    }
                }
            }
        }
...
static Value i_jumped(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    alg_set_property(v_this, "Label", alg_nil());
    return alg_nil();
}

static Value m_jumped_init_1_string(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_label = alg_widen(args[0], "String");
    (void)v_label;
    (void)(alg_set_property(v_this, "Label", alg_widen(v_label, "String")));
...
Value f_labelat(Value **cells, Value *args, int32_t count) {
    (void)cells; (void)args; (void)count;
    alg_arity(count, 2);
    Value v_statements = alg_param(args[0], "List");
    (void)v_statements;
    Value v_named = alg_param(args[1], "String");
    (void)v_named;
    {
        Value v_i = alg_int(0);
        (void)v_i;
        for (; alg_truthy(alg_less(v_i, alg_property(v_statements, "Length"))); (v_i = alg_add(v_i, alg_int(1)))) {
            if (alg_truthy(alg_is(alg_subscript_get(v_statements, v_i), "LabelStmt"))) {
                if (alg_truthy(alg_equal(f_foldcase(NULL, (Value[]){alg_str(alg_property(alg_property(alg_subscript_get(v_statements, v_i), "Name"), "Lexeme"))}, 1), f_foldcase(NULL, (Value[]){v_named}, 1)))) {
                    return v_i;
                }
            }
        }
...
void init_Interpreter(void) {
    ...
    alg_class_field(k_native, "Name");
    alg_class_field(k_native, "TheArity");
    alg_class_initializer(k_native, i_native);
    alg_class_method(k_native, "Init", m_native_init_2_string_integer, 2, t_native_init_2_string_integer);
    alg_class_method(k_native, "Arity", m_native_arity_0, 0, NULL);
    alg_class_method(k_native, "ToString", m_native_tostring_0, 0, NULL);
    alg_class_method(k_native, "Call", m_native_call_2, 2, t_native_call_2);
    fn_parsednumber = alg_closure("ParsedNumber", f_parsednumber, NULL, 0, 1, t_f_parsednumber);
    ...
    alg_class_method(k_interpreter, "VisitGotoStmt", m_interpreter_visitgotostmt_1_gotostmt, 1, t_interpreter_visitgotostmt_1_gotostmt);
    ...
    alg_class_field(k_jumped, "Label");
    alg_class_initializer(k_jumped, i_jumped);
    alg_class_method(k_jumped, "Init", m_jumped_init_1_string, 1, t_jumped_init_1_string);
    fn_labelat = alg_closure("LabelAt", f_labelat, NULL, 0, 2, t_f_labelat);
