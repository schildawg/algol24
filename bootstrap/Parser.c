...
static const char *t_parser_enclosingloop_1_string[] = { "TheLabel : String" };
static const char *t_parser_jumplabel_2_token_string[] = { "Keyword : Token", "Verb : String" };
...
static Value i_parser(Value v_this, Value *args, int32_t count) {
    ...
    alg_set_property(v_this, "PendingLabel", alg_widen(alg_string(""), "String"));
...
static Value m_parser_statement_0(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_3 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVidentifier}, 1), !alg_truthy(or_3) ? or_3 : alg_equal(alg_property(alg_invoke(v_this, "PeekNext", NULL, 0), "TypeOfToken"), e_tokentype_tokenVcolon)))) {
        return alg_invoke(v_this, "LabelStatement", NULL, 0);
    }
    ...
    while (alg_truthy(alg_bool(true))) {
        {
            ...
            if (alg_truthy((or_4 = alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVelse}, 1), alg_truthy(or_4) ? or_4 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVend}, 1)))) {
                break;
            }
        }
    }
...
static Value m_parser_bodystatement_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    if (alg_truthy((or_10 = (or_9 = (or_8 = (or_7 = (or_6 = (or_5 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVvar}, 1), alg_truthy(or_5) ? or_5 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVconst}, 1)), alg_truthy(or_6) ? or_6 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVtype}, 1)), alg_truthy(or_7) ? or_7 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVclass}, 1)), alg_truthy(or_8) ? or_8 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVobject}, 1)), alg_truthy(or_9) ? or_9 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVfunction}, 1)), alg_truthy(or_10) ? or_10 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVprocedure}, 1)))) {
...
static Value m_parser_forstatement_0(Value v_this, Value *args, int32_t count) {
    ...
    Value v_named = alg_invoke(v_this, "TakeLabel", NULL, 0);
    (void)v_named;
    ...
    (void)(alg_set_property(v_loop, "Label", alg_widen(v_named, "String")));
...
static Value m_parser_recordprivate_1(Value v_this, Value *args, int32_t count) {
    ...
    Value v_decl = args[0];
    (void)v_decl;
    if (alg_truthy((or_17 = (or_16 = (or_15 = alg_is(v_decl, "FunctionStmt"), alg_truthy(or_15) ? or_15 : alg_is(v_decl, "ClassStmt")), alg_truthy(or_16) ? or_16 : alg_is(v_decl, "ObjectStmt")), alg_truthy(or_17) ? or_17 : alg_is(v_decl, "VarStmt")))) {
        {
    ...
    if (alg_truthy(alg_is(v_decl, "VarGroupStmt"))) {
        {
            {
                Value loop_0 = alg_iterable(alg_property(v_decl, "Names"));
                for (int32_t at_0 = 0; at_0 < alg_iterable_count(loop_0); at_0++) {
                    Value v_thename = alg_iterable_at(loop_0, at_0);
                    (void)v_thename;
                    (void)(alg_invoke(alg_property(v_this, "PrivateNames"), "Add", (Value[]){alg_str(alg_property(v_thename, "Lexeme"))}, 1));
                }
            }
            return alg_nil();
        }
    ...
    if (alg_truthy(alg_is(v_decl, "EnumStmt"))) {
        {
            (void)(alg_invoke(alg_property(v_this, "PrivateNames"), "Add", (Value[]){alg_str(alg_property(alg_property(v_decl, "Name"), "Lexeme"))}, 1));
            {
                Value loop_1 = alg_iterable(alg_property(v_decl, "Members"));
                for (int32_t at_1 = 0; at_1 < alg_iterable_count(loop_1); at_1++) {
                    Value v_member = alg_iterable_at(loop_1, at_1);
                    (void)v_member;
                    (void)(alg_invoke(alg_property(v_this, "PrivateNames"), "Add", (Value[]){alg_str(alg_property(v_member, "Lexeme"))}, 1));
                }
            }
            return alg_nil();
        }
    ...
    if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVcolon}, 1))) {
        {
            ...
            if (alg_truthy((or_18 = alg_invoke(v_this, "IsCollectionType", (Value[]){v_typename}, 1), !alg_truthy(or_18) ? or_18 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVof}, 1)))) {
...
static Value m_parser_matchvisibility_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    if (alg_truthy((or_19 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVprivate}, 1), !alg_truthy(or_19) ? or_19 : alg_equal(alg_property(alg_invoke(v_this, "PeekNext", NULL, 0), "TypeOfToken"), e_tokentype_tokenVcolon)))) {
        {
            (void)(alg_invoke(v_this, "Advance", NULL, 0));
            (void)(alg_invoke(v_this, "Advance", NULL, 0));
    ...
    if (alg_truthy((or_20 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVpublic}, 1), !alg_truthy(or_20) ? or_20 : alg_equal(alg_property(alg_invoke(v_this, "PeekNext", NULL, 0), "TypeOfToken"), e_tokentype_tokenVcolon)))) {
        {
            (void)(alg_invoke(v_this, "Advance", NULL, 0));
            (void)(alg_invoke(v_this, "Advance", NULL, 0));
...
static Value m_parser_isdeclarationsection_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    return (or_22 = (or_21 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVvar}, 1), alg_truthy(or_21) ? or_21 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVconst}, 1)), alg_truthy(or_22) ? or_22 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVtype}, 1));
    return alg_nil();
}
...
static Value m_parser_isnextsection_0(Value v_this, Value *args, int32_t count) {
    ...
    return (or_29 = (or_28 = (or_27 = (or_26 = (or_25 = (or_24 = (or_23 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVend}, 1), alg_truthy(or_23) ? or_23 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVbegin}, 1)), alg_truthy(or_24) ? or_24 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVfunction}, 1)), alg_truthy(or_25) ? or_25 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVprocedure}, 1)), alg_truthy(or_26) ? or_26 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVconstructor}, 1)), alg_truthy(or_27) ? or_27 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVvar}, 1)), alg_truthy(or_28) ? or_28 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVconst}, 1)), alg_truthy(or_29) ? or_29 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVtype}, 1));
    return alg_nil();
}
    ...
    while (alg_truthy(alg_not(alg_invoke(v_this, "IsNextSection", NULL, 0)))) {
        {
            ...
            if (alg_truthy(alg_property(v_this, "InPrivateSection"))) {
                {
                    Value loop_2 = alg_iterable(v_names);
                    for (int32_t at_2 = 0; at_2 < alg_iterable_count(loop_2); at_2++) {
                        Value v_thename = alg_iterable_at(loop_2, at_2);
                        (void)v_thename;
                        (void)(alg_invoke(alg_property(v_this, "ClassPrivates"), "Add", (Value[]){alg_str(alg_property(v_thename, "Lexeme"))}, 1));
                    }
                }
            }
            Value v_typename = alg_string("");
            ...
            if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVcolon}, 1))) {
                {
                    (void)((v_typename = f_canonicaltype(NULL, (Value[]){alg_property(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect type name.")}, 2), "Lexeme")}, 1)));
                    if (alg_truthy((or_30 = alg_invoke(v_this, "IsCollectionType", (Value[]){v_typename}, 1), !alg_truthy(or_30) ? or_30 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVof}, 1)))) {
                        (void)((v_generic = alg_str(alg_property(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect generic type.")}, 2), "Lexeme"))));
                    }
                }
            }
            ...
            if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVvar}, 1))) {
                {
                    ...
                    (void)v_section;
                    {
                        Value loop_3 = alg_iterable(v_section);
                        for (int32_t at_3 = 0; at_3 < alg_iterable_count(loop_3); at_3++) {
                            Value v_declaration = alg_iterable_at(loop_3, at_3);
                            (void)v_declaration;
                            (void)(alg_invoke(v_body, "Add", (Value[]){v_declaration}, 1));
                        }
                    }
                }
            } else {
                if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVconst}, 1))) {
                    {
                        ...
                        (void)v_section;
                        {
                            Value loop_4 = alg_iterable(v_section);
                            for (int32_t at_4 = 0; at_4 < alg_iterable_count(loop_4); at_4++) {
                                Value v_declaration = alg_iterable_at(loop_4, at_4);
                                (void)v_declaration;
                                (void)(alg_invoke(v_body, "Add", (Value[]){v_declaration}, 1));
                            }
                        }
...
static Value m_parser_forinstatement_1_token(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_set_property(v_this, "LoopDepth", alg_widen(alg_subtract(alg_property(v_this, "LoopDepth"), alg_int(1)), "Integer")));
    (void)(alg_invoke(alg_property(v_this, "LoopLabels"), "RemoveAt", (Value[]){alg_subtract(alg_property(alg_property(v_this, "LoopLabels"), "Length"), alg_int(1))}, 1));
    Value v_loop = alg_new(k_forinstmt, (Value[]){v_name, v_iterable, v_body}, 3);
    (void)v_loop;
    (void)(alg_set_property(v_loop, "Label", alg_widen(v_named, "String")));
    return v_loop;
    return alg_nil();
...
static Value m_parser_breakstatement_0(Value v_this, Value *args, int32_t count) {
    ...
    Value v_named = alg_invoke(v_this, "JumpLabel", (Value[]){v_keyword, alg_string("break")}, 2);
    (void)v_named;
    (void)(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVsemicolon, alg_string("Expect ';' after 'break'.")}, 2));
    Value v_leaving = alg_new(k_breakstmt, (Value[]){v_keyword}, 1);
    (void)v_leaving;
    (void)(alg_set_property(v_leaving, "Label", alg_widen(v_named, "String")));
    return v_leaving;
    return alg_nil();
}

static Value m_parser_labelstatement_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_name = alg_nil();
    (void)v_name;
    (void)((v_name = alg_widen(alg_invoke(v_this, "Advance", NULL, 0), "Token")));
    (void)(alg_invoke(v_this, "Advance", NULL, 0));
    (void)(alg_set_property(v_this, "PendingLabel", alg_widen(alg_str(alg_property(v_name, "Lexeme")), "String")));
    Value v_inner = alg_invoke(v_this, "Statement", NULL, 0);
    (void)v_inner;
    (void)(alg_set_property(v_this, "PendingLabel", alg_widen(alg_string(""), "String")));
    return alg_new(k_labelstmt, (Value[]){v_name, v_inner}, 2);
    return alg_nil();
}

static Value m_parser_takelabel_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_taken = alg_nil();
    (void)v_taken;
    (void)((v_taken = alg_widen(alg_property(v_this, "PendingLabel"), "String")));
    (void)(alg_set_property(v_this, "PendingLabel", alg_widen(alg_string(""), "String")));
    (void)(alg_invoke(alg_property(v_this, "LoopLabels"), "Add", (Value[]){v_taken}, 1));
    return v_taken;
    return alg_nil();
}

static Value m_parser_enclosingloop_1_string(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_thelabel = alg_widen(args[0], "String");
    (void)v_thelabel;
    {
        Value loop_5 = alg_iterable(alg_property(v_this, "LoopLabels"));
        for (int32_t at_5 = 0; at_5 < alg_iterable_count(loop_5); at_5++) {
            Value v_looplabel = alg_iterable_at(loop_5, at_5);
            (void)v_looplabel;
            if (alg_truthy(alg_equal(f_foldcase(NULL, (Value[]){alg_str(v_looplabel)}, 1), f_foldcase(NULL, (Value[]){v_thelabel}, 1)))) {
                return alg_bool(true);
            }
        }
    }
...
static Value m_parser_jumplabel_2_token_string(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_keyword = alg_widen(args[0], "Token");
    (void)v_keyword;
    Value v_verb = alg_widen(args[1], "String");
    (void)v_verb;
    Value v_named = alg_nil();
    (void)v_named;
    if (alg_truthy(alg_not(alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVidentifier}, 1)))) {
        return alg_string("");
    }
    (void)((v_named = alg_widen(alg_str(alg_property(alg_invoke(v_this, "Advance", NULL, 0), "Lexeme")), "String")));
    if (alg_truthy(alg_not(alg_invoke(v_this, "EnclosingLoop", (Value[]){v_named}, 1)))) {
        alg_raise(alg_invoke(v_this, "Error", (Value[]){v_keyword, alg_add(alg_add(alg_string("No enclosing loop is labelled '"), v_named), alg_string("'."))}, 2));
    }
    return v_named;
    return alg_nil();
}
...
static Value m_parser_continuestatement_0(Value v_this, Value *args, int32_t count) {
    ...
    Value v_named = alg_invoke(v_this, "JumpLabel", (Value[]){v_keyword, alg_string("continue")}, 2);
    (void)v_named;
    (void)(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVsemicolon, alg_string("Expect ';' after 'continue'.")}, 2));
    Value v_beginning = alg_new(k_continuestmt, (Value[]){v_keyword}, 1);
    (void)v_beginning;
...
static Value m_parser_operatortoken_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    if (alg_truthy((or_35 = (or_34 = (or_33 = (or_32 = (or_31 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVplus}, 1), alg_truthy(or_31) ? or_31 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVminus}, 1)), alg_truthy(or_32) ? or_32 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVstar}, 1)), alg_truthy(or_33) ? or_33 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVslash}, 1)), alg_truthy(or_34) ? or_34 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVdiv}, 1)), alg_truthy(or_35) ? or_35 : alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVmod}, 1)))) {
        return alg_invoke(v_this, "Advance", NULL, 0);
    }
    alg_raise(alg_invoke(v_this, "Error", (Value[]){alg_invoke(v_this, "Peek", NULL, 0), alg_string("An operator must be one of + - * / div mod.")}, 2));
    return alg_nil();
}

static Value m_parser_parseoperator_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_name = alg_nil();
    (void)v_name;
    ...
    Value v_body = alg_nil();
    (void)v_body;
    (void)((v_name = alg_widen(alg_invoke(v_this, "OperatorToken", NULL, 0), "Token")));
    (void)(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVleftVparen, alg_string("Expect '(' after operator.")}, 2));
    ...
    (void)(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVrightVparen, alg_string("Expect ')' after operator parameters.")}, 2));
    if (alg_truthy(alg_greater(alg_property(v_params, "Length"), alg_int(1)))) {
        alg_raise(alg_invoke(v_this, "Error", (Value[]){v_name, alg_string("An operator takes one argument, or none for a unary one.")}, 2));
    }
    ...
    if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVcolon}, 1))) {
        {
            (void)((v_returntype = f_canonicaltype(NULL, (Value[]){alg_property(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect type name.")}, 2), "Lexeme")}, 1)));
            if (alg_truthy((or_36 = alg_invoke(v_this, "IsCollectionType", (Value[]){v_returntype}, 1), !alg_truthy(or_36) ? or_36 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVof}, 1)))) {
    ...
    (void)(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVsemicolon, alg_string("Expect ';' after operator signature.")}, 2));
    (void)((v_body = alg_widen(alg_list(), "List")));
    (void)(alg_invoke(v_this, "ReadDeclarationSections", (Value[]){v_body}, 1));
    (void)(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVbegin, alg_string("Expect 'begin' before operator body.")}, 2));
    Value v_wasinprocedure = alg_property(v_this, "InProcedure");
    (void)v_wasinprocedure;
    (void)(alg_set_property(v_this, "InProcedure", alg_widen(alg_bool(false), "Boolean")));
    Value v_rest = alg_invoke(v_this, "Block", NULL, 0);
    (void)v_rest;
    (void)(alg_set_property(v_this, "InProcedure", alg_widen(v_wasinprocedure, "Boolean")));
    {
        Value loop_6 = alg_iterable(v_rest);
        for (int32_t at_6 = 0; at_6 < alg_iterable_count(loop_6); at_6++) {
            Value v_each = alg_iterable_at(loop_6, at_6);
            (void)v_each;
            (void)(alg_invoke(v_body, "Add", (Value[]){v_each}, 1));
        }
    }
    Value v_theoperator = alg_new(k_functionstmt, (Value[]){v_name, v_params, v_body}, 3);
    (void)v_theoperator;
    (void)(alg_set_property(v_theoperator, "ReturnType", alg_widen(v_returntype, "String")));
    (void)(alg_set_property(v_theoperator, "ReturnGeneric", alg_widen(v_returngeneric, "String")));
    (void)(alg_set_property(v_theoperator, "ParamTypes", alg_widen(v_paramtypes, "List")));
    (void)(alg_set_property(v_theoperator, "ParamGenerics", alg_widen(v_paramgenerics, "List")));
    return v_theoperator;
    return alg_nil();
}

static Value m_parser_parseproperty_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    Value v_name = alg_nil();
    (void)v_name;
    Value v_body = alg_nil();
    (void)v_body;
    (void)((v_name = alg_widen(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect property name.")}, 2), "Token")));
    Value v_returntype = alg_string("");
    (void)v_returntype;
    Value v_returngeneric = alg_string("");
    (void)v_returngeneric;
    if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVcolon}, 1))) {
        {
            (void)((v_returntype = f_canonicaltype(NULL, (Value[]){alg_property(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect type name.")}, 2), "Lexeme")}, 1)));
            if (alg_truthy((or_37 = alg_invoke(v_this, "IsCollectionType", (Value[]){v_returntype}, 1), !alg_truthy(or_37) ? or_37 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVof}, 1)))) {
                (void)((v_returngeneric = alg_str(alg_property(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect generic type.")}, 2), "Lexeme"))));
            }
        }
    }
    (void)(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVsemicolon, alg_string("Expect ';' after property signature.")}, 2));
    (void)((v_body = alg_widen(alg_list(), "List")));
    (void)(alg_invoke(v_this, "ReadDeclarationSections", (Value[]){v_body}, 1));
    (void)(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVbegin, alg_string("Expect 'begin' before property body.")}, 2));
    Value v_wasinprocedure = alg_property(v_this, "InProcedure");
    (void)v_wasinprocedure;
    (void)(alg_set_property(v_this, "InProcedure", alg_widen(alg_bool(false), "Boolean")));
    Value v_rest = alg_invoke(v_this, "Block", NULL, 0);
    ...
    (void)(alg_set_property(v_this, "InProcedure", alg_widen(v_wasinprocedure, "Boolean")));
    {
        Value loop_7 = alg_iterable(v_rest);
        for (int32_t at_7 = 0; at_7 < alg_iterable_count(loop_7); at_7++) {
            Value v_each = alg_iterable_at(loop_7, at_7);
            (void)v_each;
            (void)(alg_invoke(v_body, "Add", (Value[]){v_each}, 1));
        }
    }
    Value v_theproperty = alg_new(k_functionstmt, (Value[]){v_name, alg_list(), v_body}, 3);
    (void)v_theproperty;
    (void)(alg_set_property(v_theproperty, "ReturnType", alg_widen(v_returntype, "String")));
    (void)(alg_set_property(v_theproperty, "ReturnGeneric", alg_widen(v_returngeneric, "String")));
    (void)(alg_set_property(v_theproperty, "IsProperty", alg_widen(alg_bool(true), "Boolean")));
    return v_theproperty;
    return alg_nil();
}
...
static Value m_parser_trystatement_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_exceptstmts;
    (void)((v_statements = alg_widen(alg_list(), "List")));
    while (alg_truthy((or_38 = alg_not(alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVexcept}, 1)), !alg_truthy(or_38) ? or_38 : alg_not(alg_invoke(v_this, "IsAtEnd", NULL, 0))))) {
    ...
    if (alg_truthy((or_40 = alg_not(v_hashandlers), alg_truthy(or_40) ? or_40 : alg_not(alg_property(v_exceptstmts, "IsEmpty"))))) {
        {
            if (alg_truthy((or_41 = alg_not(alg_property(v_exceptstmts, "IsEmpty")), !alg_truthy(or_41) ? or_41 : alg_invoke(v_handlers, "Contains", (Value[]){alg_string("default")}, 1)))) {
...
static Value m_parser_vardeclaration_1_token(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVcolon}, 1))) {
        {
            (void)((v_typename = f_canonicaltype(NULL, (Value[]){alg_property(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect type name.")}, 2), "Lexeme")}, 1)));
            if (alg_truthy((or_42 = alg_invoke(v_this, "IsCollectionType", (Value[]){v_typename}, 1), !alg_truthy(or_42) ? or_42 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVof}, 1)))) {
                (void)((v_generic = alg_str(alg_property(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect generic type.")}, 2), "Lexeme"))));
            }
        }
    }
...
static Value m_parser_parsefunction_1_string(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_43 = alg_invoke(v_this, "IsCollectionType", (Value[]){v_returntype}, 1), !alg_truthy(or_43) ? or_43 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVof}, 1)))) {
        (void)((v_returngeneric = alg_str(alg_property(alg_invoke(v_this, "Consume", (Value[]){e_tokentype_tokenVidentifier, alg_string("Expect generic type.")}, 2), "Lexeme"))));
    }
    ...
    (void)(alg_set_property(v_this, "InProcedure", alg_widen(v_wasinprocedure, "Boolean")));
    {
        Value loop_8 = alg_iterable(v_rest);
        for (int32_t at_8 = 0; at_8 < alg_iterable_count(loop_8); at_8++) {
            Value v_each = alg_iterable_at(loop_8, at_8);
            (void)v_each;
            (void)(alg_invoke(v_body, "Add", (Value[]){v_each}, 1));
        }
    }
...
static Value m_parser_parametertype_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_typename;
    if (alg_truthy((or_44 = alg_invoke(v_this, "IsCollectionType", (Value[]){v_typename}, 1), !alg_truthy(or_44) ? or_44 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVof}, 1)))) {
...
static Value m_parser_block_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_statements;
    (void)((v_statements = alg_widen(alg_list(), "List")));
    while (alg_truthy((or_45 = alg_not(alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVend}, 1)), !alg_truthy(or_45) ? or_45 : alg_not(alg_invoke(v_this, "IsAtEnd", NULL, 0))))) {
        {
            (void)(alg_invoke(v_statements, "Add", (Value[]){alg_invoke(v_this, "Declaration", NULL, 0)}, 1));
        }
    }
...
static Value m_parser_istestblock_0(Value v_this, Value *args, int32_t count) {
    ...
    return (or_46 = alg_equal(alg_property(alg_invoke(v_this, "PeekNext", NULL, 0), "TypeOfToken"), e_tokentype_tokenVstring), alg_truthy(or_46) ? or_46 : alg_equal(alg_property(alg_invoke(v_this, "PeekNext", NULL, 0), "TypeOfToken"), e_tokentype_tokenVchar));
    return alg_nil();
}
...
static Value m_parser_classdeclaration_1_string(Value v_this, Value *args, int32_t count) {
    ...
    {
        Value loop_9 = alg_iterable(v_section);
        for (int32_t at_9 = 0; at_9 < alg_iterable_count(loop_9); at_9++) {
            Value v_each = alg_iterable_at(loop_9, at_9);
            (void)v_each;
            {
                if (alg_truthy(alg_is(v_each, "VarGroupStmt"))) {
                    {
                        {
                            Value loop_10 = alg_iterable(alg_property(v_each, "Names"));
                            for (int32_t at_10 = 0; at_10 < alg_iterable_count(loop_10); at_10++) {
                                Value v_thename = alg_iterable_at(loop_10, at_10);
                                (void)v_thename;
                                {
                                    Value v_field = alg_new(k_varstmt, (Value[]){v_thename, alg_property(v_each, "Initializer")}, 2);
                                    (void)v_field;
    ...
    while (alg_truthy((or_47 = alg_not(alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVend}, 1)), !alg_truthy(or_47) ? or_47 : alg_not(alg_invoke(v_this, "IsAtEnd", NULL, 0))))) {
        {
            while (alg_truthy(alg_invoke(v_this, "MatchVisibility", NULL, 0))) {
                {
                }
            }
            if (alg_truthy((or_48 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVend}, 1), alg_truthy(or_48) ? or_48 : alg_invoke(v_this, "IsAtEnd", NULL, 0)))) {
                break;
            }
            ...
            if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVconstructor}, 1))) {
                ...
                if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVprocedure}, 1))) {
                    ...
                    if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVproperty}, 1))) {
                        (void)((v_method = alg_widen(alg_invoke(v_this, "ParseProperty", NULL, 0), "Stmt")));
                    } else {
                        if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVoperator}, 1))) {
                            (void)((v_method = alg_widen(alg_invoke(v_this, "ParseOperator", NULL, 0), "Stmt")));
                        } else {
                            {
...
static Value m_parser_equality_0(Value v_this, Value *args, int32_t count) {
    ...
    Value v_theexpr = alg_nil();
    (void)v_theexpr;
    Value v_theoperator = alg_nil();
    (void)v_theoperator;
    Value v_right = alg_nil();
    (void)v_right;
    (void)((v_theexpr = alg_widen(alg_invoke(v_this, "Comparison", NULL, 0), "Expr")));
    while (alg_truthy((or_49 = alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVnotVequal}, 1), alg_truthy(or_49) ? or_49 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVequal}, 1)))) {
        {
            (void)((v_theoperator = alg_widen(alg_invoke(v_this, "Previous", NULL, 0), "Token")));
            (void)((v_right = alg_widen(alg_invoke(v_this, "Comparison", NULL, 0), "Expr")));
            (void)((v_theexpr = alg_widen(alg_new(k_binaryexpr, (Value[]){v_theexpr, v_theoperator, v_right}, 3), "Expr")));
        }
    }
    return v_theexpr;
    return alg_nil();
    ...
    while (alg_truthy(alg_bool(true))) {
        {
            if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVis}, 1))) {
                ...
                if (alg_truthy((or_53 = (or_52 = (or_51 = (or_50 = alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVgreater}, 1), alg_truthy(or_50) ? or_50 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVgreaterVequal}, 1)), alg_truthy(or_51) ? or_51 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVless}, 1)), alg_truthy(or_52) ? or_52 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVlessVequal}, 1)), alg_truthy(or_53) ? or_53 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVin}, 1)))) {
                    {
                        (void)((v_theoperator = alg_widen(alg_invoke(v_this, "Previous", NULL, 0), "Token")));
...
static Value m_parser_term_0(Value v_this, Value *args, int32_t count) {
    ...
    while (alg_truthy((or_54 = alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVminus}, 1), alg_truthy(or_54) ? or_54 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVplus}, 1)))) {
        {
            (void)((v_theoperator = alg_widen(alg_invoke(v_this, "Previous", NULL, 0), "Token")));
...
static Value m_parser_factor_0(Value v_this, Value *args, int32_t count) {
    ...
    while (alg_truthy((or_57 = (or_56 = (or_55 = alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVslash}, 1), alg_truthy(or_55) ? or_55 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVstar}, 1)), alg_truthy(or_56) ? or_56 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVdiv}, 1)), alg_truthy(or_57) ? or_57 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVmod}, 1)))) {
        {
            (void)((v_theoperator = alg_widen(alg_invoke(v_this, "Previous", NULL, 0), "Token")));
...
static Value m_parser_unary_0(Value v_this, Value *args, int32_t count) {
    ...
    Value v_theexpr = alg_nil();
    (void)v_theexpr;
    if (alg_truthy((or_58 = alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVnot}, 1), alg_truthy(or_58) ? or_58 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVminus}, 1)))) {
        {
            (void)((v_theoperator = alg_widen(alg_invoke(v_this, "Previous", NULL, 0), "Token")));
            (void)((v_right = alg_widen(alg_invoke(v_this, "Unary", NULL, 0), "Expr")));
            return alg_new(k_unaryexpr, (Value[]){v_theoperator, v_right}, 2);
        }
    }
...
static Value m_parser_argument_2_list_list(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_names;
    if (alg_truthy((or_59 = alg_invoke(v_this, "Check", (Value[]){e_tokentype_tokenVidentifier}, 1), !alg_truthy(or_59) ? or_59 : alg_equal(alg_property(alg_invoke(v_this, "PeekNext", NULL, 0), "TypeOfToken"), e_tokentype_tokenVcolon)))) {
        {
    ...
    if (alg_truthy((or_60 = alg_greater(alg_property(v_names, "Length"), alg_int(0)), !alg_truthy(or_60) ? or_60 : alg_not_equal(alg_str(alg_subscript_get(v_names, alg_subtract(alg_property(v_names, "Length"), alg_int(1)))), alg_string(""))))) {
...
static Value m_parser_primary_0(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_63 = (or_62 = (or_61 = alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVinteger}, 1), alg_truthy(or_61) ? or_61 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVnumber}, 1)), alg_truthy(or_62) ? or_62 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVstring}, 1)), alg_truthy(or_63) ? or_63 : alg_invoke(v_this, "Match", (Value[]){e_tokentype_tokenVchar}, 1)))) {
        {
...
void init_Parser(void) {
    ...
    alg_class_field(k_parser, "PendingLabel");
    alg_class_field(k_parser, "LoopLabels");
    ...
    alg_class_method(k_parser, "LabelStatement", m_parser_labelstatement_0, 0, NULL);
    alg_class_method(k_parser, "TakeLabel", m_parser_takelabel_0, 0, NULL);
    ...
    alg_class_method(k_parser, "OperatorToken", m_parser_operatortoken_0, 0, NULL);
    alg_class_method(k_parser, "ParseOperator", m_parser_parseoperator_0, 0, NULL);
    alg_class_method(k_parser, "ParseProperty", m_parser_parseproperty_0, 0, NULL);
