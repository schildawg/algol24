...
static Value m_Parser_CaseStatement_0(Value v_this, Value *args, int32_t count) {
    ...
    while (alg_truthy(alg_bool(true))) {
        {
            ...
            if (alg_truthy((or_0 = alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_ELSE}, 1), alg_truthy(or_0) ? or_0 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_END}, 1)))) {
                break;
            }
        }
    }
    if (alg_truthy(alg_equal(alg_property(alg_invoke(v_this, "Previous", NULL, 0), "TypeOfToken"), e_TokenType_TOKEN_ELSE))) {
        {
            (void)(alg_set_property(v_Current, "ElseBranch", alg_invoke(v_this, "Statement", NULL, 0)));
...
static Value m_Parser_IfStatement_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)((v_ThenBranch = alg_invoke(v_this, "Statement", NULL, 0)));
    if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_ELSE}, 1))) {
        {
            (void)((v_ElseBranch = alg_invoke(v_this, "Statement", NULL, 0)));
        }
    }
...
static Value m_Parser_ForStatement_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)((v_Body = alg_invoke(v_this, "Statement", NULL, 0)));
...
static Value m_Parser_RecordPrivate_1(Value v_this, Value *args, int32_t count) {
    ...
    Value v_Decl = args[0];
    (void)v_Decl;
    if (alg_truthy((or_2 = (or_1 = alg_is(v_Decl, "FunctionStmt"), alg_truthy(or_1) ? or_1 : alg_is(v_Decl, "ClassStmt")), alg_truthy(or_2) ? or_2 : alg_is(v_Decl, "VarStmt")))) {
    ...
    if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_COLON}, 1))) {
        {
            ...
            if (alg_truthy((or_3 = alg_equal(f_ToLower(NULL, (Value[]){v_TypeName}, 1), alg_string("list")), !alg_truthy(or_3) ? or_3 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_OF}, 1)))) {
...
static Value m_Parser_MatchVisibility_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    if (alg_truthy((or_4 = alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_PRIVATE}, 1), !alg_truthy(or_4) ? or_4 : alg_equal(alg_property(alg_invoke(v_this, "PeekNext", NULL, 0), "TypeOfToken"), e_TokenType_TOKEN_COLON)))) {
        {
    ...
    if (alg_truthy((or_5 = alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_PUBLIC}, 1), !alg_truthy(or_5) ? or_5 : alg_equal(alg_property(alg_invoke(v_this, "PeekNext", NULL, 0), "TypeOfToken"), e_TokenType_TOKEN_COLON)))) {
        {
            (void)(alg_invoke(v_this, "Advance", NULL, 0));
            (void)(alg_invoke(v_this, "Advance", NULL, 0));
...
static Value m_Parser_IsDeclarationSection_0(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    return (or_7 = (or_6 = alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_VAR}, 1), alg_truthy(or_6) ? or_6 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_CONST}, 1)), alg_truthy(or_7) ? or_7 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_TYPE}, 1));
    return alg_nil();
}
...
static Value m_Parser_IsNextSection_0(Value v_this, Value *args, int32_t count) {
    ...
    return (or_14 = (or_13 = (or_12 = (or_11 = (or_10 = (or_9 = (or_8 = alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_END}, 1), alg_truthy(or_8) ? or_8 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_BEGIN}, 1)), alg_truthy(or_9) ? or_9 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_FUNCTION}, 1)), alg_truthy(or_10) ? or_10 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_PROCEDURE}, 1)), alg_truthy(or_11) ? or_11 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_CONSTRUCTOR}, 1)), alg_truthy(or_12) ? or_12 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_VAR}, 1)), alg_truthy(or_13) ? or_13 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_CONST}, 1)), alg_truthy(or_14) ? or_14 : alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_TYPE}, 1));
    return alg_nil();
}
    ...
    while (alg_truthy(alg_not(alg_invoke(v_this, "IsNextSection", NULL, 0)))) {
        {
            ...
            if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_COLON}, 1))) {
                {
                    (void)((v_TypeName = alg_str(alg_property(alg_invoke(v_this, "Consume", (Value[]){e_TokenType_TOKEN_IDENTIFIER, alg_string("Expect type name.")}, 2), "Lexeme"))));
                    if (alg_truthy((or_15 = alg_equal(f_ToLower(NULL, (Value[]){v_TypeName}, 1), alg_string("list")), !alg_truthy(or_15) ? or_15 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_OF}, 1)))) {
                        (void)((v_Generic = alg_str(alg_property(alg_invoke(v_this, "Consume", (Value[]){e_TokenType_TOKEN_IDENTIFIER, alg_string("Expect generic type.")}, 2), "Lexeme"))));
                    }
                }
            }
...
static Value m_Parser_TryStatement_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_ExceptStmts;
    (void)((v_Statements = alg_list()));
    while (alg_truthy((or_16 = alg_not(alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_EXCEPT}, 1)), !alg_truthy(or_16) ? or_16 : alg_not(alg_invoke(v_this, "IsAtEnd", NULL, 0))))) {
    ...
    while (alg_truthy((or_17 = alg_not(alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_END}, 1)), !alg_truthy(or_17) ? or_17 : alg_not(alg_invoke(v_this, "IsAtEnd", NULL, 0))))) {
        (void)(alg_invoke(v_ExceptStmts, "Add", (Value[]){alg_invoke(v_this, "Statement", NULL, 0)}, 1));
    }
    if (alg_truthy((or_18 = alg_not(v_HasHandlers), alg_truthy(or_18) ? or_18 : alg_not(alg_property(v_ExceptStmts, "IsEmpty"))))) {
        {
            if (alg_truthy((or_19 = alg_not(alg_property(v_ExceptStmts, "IsEmpty")), !alg_truthy(or_19) ? or_19 : alg_invoke(v_Handlers, "Contains", (Value[]){alg_string("default")}, 1)))) {
...
static Value m_Parser_VarDeclaration_1_Token(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_COLON}, 1))) {
        {
            (void)((v_TypeName = alg_str(alg_property(alg_invoke(v_this, "Consume", (Value[]){e_TokenType_TOKEN_IDENTIFIER, alg_string("Expect type name.")}, 2), "Lexeme"))));
            if (alg_truthy((or_20 = alg_equal(f_ToLower(NULL, (Value[]){v_TypeName}, 1), alg_string("list")), !alg_truthy(or_20) ? or_20 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_OF}, 1)))) {
                (void)((v_Generic = alg_str(alg_property(alg_invoke(v_this, "Consume", (Value[]){e_TokenType_TOKEN_IDENTIFIER, alg_string("Expect generic type.")}, 2), "Lexeme"))));
            }
        }
    }
...
static Value m_Parser_Block_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_Statements;
    (void)((v_Statements = alg_list()));
    while (alg_truthy((or_21 = alg_not(alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_END}, 1)), !alg_truthy(or_21) ? or_21 : alg_not(alg_invoke(v_this, "IsAtEnd", NULL, 0))))) {
        {
            (void)(alg_invoke(v_Statements, "Add", (Value[]){alg_invoke(v_this, "Declaration", NULL, 0)}, 1));
        }
    }
...
static Value m_Parser_ClassDeclaration_1_String(Value v_this, Value *args, int32_t count) {
    ...
    while (alg_truthy((or_22 = alg_not(alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_END}, 1)), !alg_truthy(or_22) ? or_22 : alg_not(alg_invoke(v_this, "IsAtEnd", NULL, 0))))) {
        {
            while (alg_truthy(alg_invoke(v_this, "MatchVisibility", NULL, 0))) {
                {
                }
            }
            if (alg_truthy((or_23 = alg_invoke(v_this, "Check", (Value[]){e_TokenType_TOKEN_END}, 1), alg_truthy(or_23) ? or_23 : alg_invoke(v_this, "IsAtEnd", NULL, 0)))) {
                break;
            }
...
static Value m_Parser_Equality_0(Value v_this, Value *args, int32_t count) {
    ...
    while (alg_truthy((or_24 = alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_NOT_EQUAL}, 1), alg_truthy(or_24) ? or_24 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_EQUAL}, 1)))) {
        {
    ...
    while (alg_truthy(alg_bool(true))) {
        {
            if (alg_truthy(alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_IS}, 1))) {
                ...
                if (alg_truthy((or_28 = (or_27 = (or_26 = (or_25 = alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_GREATER}, 1), alg_truthy(or_25) ? or_25 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_GREATER_EQUAL}, 1)), alg_truthy(or_26) ? or_26 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_LESS}, 1)), alg_truthy(or_27) ? or_27 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_LESS_EQUAL}, 1)), alg_truthy(or_28) ? or_28 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_IN}, 1)))) {
                    {
                        (void)((v_Operator = alg_invoke(v_this, "Previous", NULL, 0)));
...
static Value m_Parser_Term_0(Value v_this, Value *args, int32_t count) {
    ...
    while (alg_truthy((or_29 = alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_MINUS}, 1), alg_truthy(or_29) ? or_29 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_PLUS}, 1)))) {
        {
            (void)((v_Operator = alg_invoke(v_this, "Previous", NULL, 0)));
...
static Value m_Parser_Factor_0(Value v_this, Value *args, int32_t count) {
    ...
    while (alg_truthy((or_30 = alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_SLASH}, 1), alg_truthy(or_30) ? or_30 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_STAR}, 1)))) {
        {
            (void)((v_Operator = alg_invoke(v_this, "Previous", NULL, 0)));
...
static Value m_Parser_Unary_0(Value v_this, Value *args, int32_t count) {
    ...
    Value v_Right = alg_nil();
    (void)v_Right;
    if (alg_truthy((or_31 = alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_NOT}, 1), alg_truthy(or_31) ? or_31 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_MINUS}, 1)))) {
        {
            (void)((v_Operator = alg_invoke(v_this, "Previous", NULL, 0)));
            (void)((v_Right = alg_invoke(v_this, "Unary", NULL, 0)));
...
static Value m_Parser_Primary_0(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_34 = (or_33 = (or_32 = alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_INTEGER}, 1), alg_truthy(or_32) ? or_32 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_NUMBER}, 1)), alg_truthy(or_33) ? or_33 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_STRING}, 1)), alg_truthy(or_34) ? or_34 : alg_invoke(v_this, "Match", (Value[]){e_TokenType_TOKEN_CHAR}, 1)))) {
        {
