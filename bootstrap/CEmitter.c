...
static Value i_CEmitter(Value v_this, Value *args, int32_t count) {
    (void)v_this; (void)args; (void)count;
    alg_set_property(v_this, "Declarations", alg_string(""));
    alg_set_property(v_this, "Functions", alg_string(""));
    alg_set_property(v_this, "MainBody", alg_string(""));
    alg_set_property(v_this, "Setup", alg_string(""));
    alg_set_property(v_this, "Body", alg_string(""));
...
static Value m_CEmitter_Line_1(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_equal(alg_property(v_this, "Target"), alg_string("body")))) {
        (void)(alg_set_property(v_this, "Body", alg_add(alg_add(alg_add(alg_property(v_this, "Body"), f_Indentation(NULL, (Value[]){alg_property(v_this, "Depth")}, 1)), alg_str(v_Text)), alg_char_value(10))));
    } else {
        (void)(alg_set_property(v_this, "MainBody", alg_add(alg_add(alg_add(alg_property(v_this, "MainBody"), f_Indentation(NULL, (Value[]){alg_property(v_this, "Depth")}, 1)), alg_str(v_Text)), alg_char_value(10))));
    }
    return alg_nil();
}
...
static Value m_CEmitter_Mangle_2_String_String(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_Result;
    {
        Value v_I = alg_int(0);
        (void)v_I;
        while (alg_truthy(alg_less(v_I, alg_length(v_Renamed)))) {
            {
                {
                    Value v_C = alg_subscript_get(alg_str(v_Renamed), v_I);
                    (void)v_C;
    ...
    return alg_add(v_Prefix, v_Result);
    return alg_nil();
}
            ...
            {
                {
                    Value v_C = alg_subscript_get(alg_str(v_Text), v_I);
                    (void)v_C;
                    if (alg_truthy((or_4 = (or_2 = ((or_0 = alg_greater_equal(v_C, alg_char_value(97)), !alg_truthy(or_0) ? or_0 : alg_less_equal(v_C, alg_char_value(122)))), alg_truthy(or_2) ? or_2 : ((or_1 = alg_greater_equal(v_C, alg_char_value(65)), !alg_truthy(or_1) ? or_1 : alg_less_equal(v_C, alg_char_value(90))))), alg_truthy(or_4) ? or_4 : ((or_3 = alg_greater_equal(v_C, alg_char_value(48)), !alg_truthy(or_3) ? or_3 : alg_less_equal(v_C, alg_char_value(57))))))) {
                        (void)((v_Result = alg_add(v_Result, alg_str(v_C))));
                    } else {
...
static Value m_CEmitter_DeclareValue_2_String_String(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_invoke(v_this, "Exported", (Value[]){v_Name}, 1))) {
        {
            (void)(alg_set_property(v_this, "Declarations", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Declarations"), alg_string("Value ")), v_Symbol), alg_char_value(59)), alg_char_value(10))));
        ...
        (void)(alg_set_property(v_this, "Declarations", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Declarations"), alg_string("static Value ")), v_Symbol), alg_char_value(59)), alg_char_value(10))));
    }
    return alg_nil();
}
                    ...
                    if (alg_truthy(alg_is(v_TheStmt, "EnumStmt"))) {
                        {
                            (void)(alg_invoke(alg_property(v_this, "EnumTypes"), "Add", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1));
                            {
                                ...
                                while (alg_truthy(alg_less(v_J, alg_property(alg_property(v_TheStmt, "Members"), "Length")))) {
                                    {
                                        (void)(alg_invoke(alg_property(v_this, "EnumMembers"), "Put", (Value[]){alg_str(alg_property(alg_subscript_get(alg_property(v_TheStmt, "Members"), v_J), "Lexeme")), alg_add(alg_add(alg_add(alg_string("e_"), alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))), alg_char_value(95)), alg_str(alg_property(alg_subscript_get(alg_property(v_TheStmt, "Members"), v_J), "Lexeme")))}, 2));
            ...
            {
                {
                    ...
                    (void)v_Unit;
                    (void)(alg_set_property(v_this, "Declarations", alg_string("")));
                    (void)(alg_set_property(v_this, "Functions", alg_string("")));
                    (void)(alg_set_property(v_this, "Setup", alg_string("")));
                    (void)(alg_set_property(v_this, "MainBody", alg_string("")));
                            ...
                            {
                                {
                                    ...
                                    (void)v_TheStmt;
                                    if (alg_truthy((or_5 = alg_is(v_TheStmt, "FunctionStmt"), !alg_truthy(or_5) ? or_5 : alg_not(alg_invoke(v_this, "IsTest", (Value[]){v_TheStmt}, 1))))) {
                                        {
                                            (void)(alg_set_property(v_this, "Declarations", alg_add(alg_add(alg_add(alg_property(v_this, "Declarations"), alg_invoke(v_this, "Prototype", (Value[]){v_TheStmt}, 1)), alg_char_value(59)), alg_char_value(10))));
                                            if (alg_truthy(alg_invoke(v_this, "Exported", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1))) {
                    ...
                    if (alg_truthy(v_IsMain)) {
                        {
                            ...
                            (void)((v_MainBodyText = alg_property(v_this, "MainBody")));
...
static Value m_CEmitter_UnitSource_4_List_Boolean_String(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_greater(alg_length(alg_property(v_this, "Declarations")), alg_int(0)))) {
        (void)((v_Text = alg_add(alg_add(v_Text, alg_property(v_this, "Declarations")), alg_char_value(10))));
    }
    if (alg_truthy(alg_greater(alg_length(alg_property(v_this, "Functions")), alg_int(0)))) {
        (void)((v_Text = alg_add(v_Text, alg_property(v_this, "Functions"))));
    }
    (void)((v_Text = alg_add(alg_add(alg_add(alg_add(v_Text, alg_string("void init_")), alg_str(alg_property(v_Unit, "Name"))), alg_string("(void) {")), alg_char_value(10))));
    (void)((v_Text = alg_add(v_Text, alg_property(v_this, "Setup"))));
    (void)((v_Text = alg_add(v_Text, alg_property(v_this, "MainBody"))));
...
static Value m_CEmitter_EmitTestRunner_0(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_Files;
    {
        ...
        while (alg_truthy(alg_less(v_I, alg_property(alg_property(v_this, "TestSymbols"), "Length")))) {
            {
                (void)(alg_set_property(v_this, "Declarations", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Declarations"), alg_string("Value ")), alg_str(alg_subscript_get(alg_property(v_this, "TestSymbols"), v_I))), alg_string("(Value **cells, Value *args, int32_t count);")), alg_char_value(10))));
                (void)((v_I = alg_add(v_I, alg_int(1))));
            }
        }
    }
    (void)(alg_set_property(v_this, "MainBody", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "MainBody"), alg_string("    alg_test_begin(")), alg_str(alg_property(alg_property(v_this, "Tests"), "Length"))), alg_string(");")), alg_char_value(10))));
    ...
    }
    {
        ...
        while (alg_truthy(alg_less(v_F, alg_property(v_Files, "Length")))) {
            {
                {
                    (void)(alg_set_property(v_this, "MainBody", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "MainBody"), alg_string("    alg_test_file(")), f_QuoteC(NULL, (Value[]){alg_str(alg_subscript_get(v_Files, v_F))}, 1)), alg_string(");")), alg_char_value(10))));
                    ...
                    }
                    {
                        ...
                        while (alg_truthy(alg_less(v_A, alg_property(v_Ordered, "Length")))) {
                            {
                                (void)(alg_set_property(v_this, "MainBody", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "MainBody"), alg_string("    alg_test_run(")), f_QuoteC(NULL, (Value[]){alg_str(alg_property(alg_property(alg_subscript_get(alg_property(v_this, "Tests"), alg_subscript_get(v_Ordered, v_A)), "Name"), "Literal"))}, 1)), alg_string(", ")), alg_str(alg_subscript_get(alg_property(v_this, "TestSymbols"), alg_subscript_get(v_Ordered, v_A)))), alg_string(");")), alg_char_value(10))));
                                (void)((v_A = alg_add(v_A, alg_int(1))));
                            }
                        }
                    }
                    (void)(alg_set_property(v_this, "MainBody", alg_add(alg_add(alg_property(v_this, "MainBody"), alg_string("    alg_test_end_file();")), alg_char_value(10))));
                }
                (void)((v_F = alg_add(v_F, alg_int(1))));
            }
        }
    }
    (void)(alg_set_property(v_this, "MainBody", alg_add(alg_add(alg_property(v_this, "MainBody"), alg_string("    return alg_test_summary();")), alg_char_value(10))));
    return alg_nil();
}
...
static Value m_CEmitter_EmitTest_1(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_set_property(v_this, "Body", alg_string("")));
    ...
    Value v_Written = alg_property(v_this, "Body");
    (void)v_Written;
    ...
    (void)(alg_set_property(v_this, "Declarations", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Declarations"), alg_string("Value ")), v_Symbol), alg_string("(Value **cells, Value *args, int32_t count);")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("Value ")), v_Symbol), alg_string("(Value **cells, Value *args, int32_t count) {")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("    (void)cells; (void)args; (void)count;")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_property(v_this, "Functions"), v_Written)));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("    return alg_nil();")), alg_char_value(10)), alg_char_value(125)), alg_char_value(10)), alg_char_value(10))));
    return alg_nil();
}
            ...
            {
                {
                    ...
                    if (alg_truthy((or_6 = alg_is(v_TheStmt, "BlockStmt"), !alg_truthy(or_6) ? or_6 : alg_invoke(v_this, "DeclaresNested", (Value[]){alg_property(v_TheStmt, "Statements")}, 1)))) {
                        return alg_bool(true);
                    }
                    if (alg_truthy((or_7 = alg_is(v_TheStmt, "WhileStmt"), !alg_truthy(or_7) ? or_7 : alg_invoke(v_this, "DeclaresNested", (Value[]){alg_list_keep(alg_list(), alg_property(v_TheStmt, "Body"))}, 1)))) {
                        return alg_bool(true);
                    }
                    if (alg_truthy((or_8 = alg_is(v_TheStmt, "ForInStmt"), !alg_truthy(or_8) ? or_8 : alg_invoke(v_this, "DeclaresNested", (Value[]){alg_list_keep(alg_list(), alg_property(v_TheStmt, "Body"))}, 1)))) {
                        return alg_bool(true);
                    }
                    if (alg_truthy(alg_is(v_TheStmt, "IfStmt"))) {
                        {
                            ...
                            if (alg_truthy((or_9 = alg_not_equal(alg_property(v_TheStmt, "ElseBranch"), alg_nil()), !alg_truthy(or_9) ? or_9 : alg_invoke(v_this, "DeclaresNested", (Value[]){alg_list_keep(alg_list(), alg_property(v_TheStmt, "ElseBranch"))}, 1)))) {
                                return alg_bool(true);
                            }
                        }
                    }
            ...
            {
                {
                    ...
                    if (alg_truthy((or_10 = alg_is(v_TheStmt, "BlockStmt"), !alg_truthy(or_10) ? or_10 : alg_invoke(v_this, "ContainsTry", (Value[]){alg_property(v_TheStmt, "Statements")}, 1)))) {
                        return alg_bool(true);
                    }
                    if (alg_truthy((or_11 = alg_is(v_TheStmt, "WhileStmt"), !alg_truthy(or_11) ? or_11 : alg_invoke(v_this, "ContainsTry", (Value[]){alg_list_keep(alg_list(), alg_property(v_TheStmt, "Body"))}, 1)))) {
                        return alg_bool(true);
                    }
                    if (alg_truthy((or_12 = alg_is(v_TheStmt, "ForInStmt"), !alg_truthy(or_12) ? or_12 : alg_invoke(v_this, "ContainsTry", (Value[]){alg_list_keep(alg_list(), alg_property(v_TheStmt, "Body"))}, 1)))) {
                        return alg_bool(true);
                    }
                    if (alg_truthy(alg_is(v_TheStmt, "IfStmt"))) {
                        {
                            ...
                            if (alg_truthy((or_13 = alg_not_equal(alg_property(v_TheStmt, "ElseBranch"), alg_nil()), !alg_truthy(or_13) ? or_13 : alg_invoke(v_this, "ContainsTry", (Value[]){alg_list_keep(alg_list(), alg_property(v_TheStmt, "ElseBranch"))}, 1)))) {
                                return alg_bool(true);
                            }
                        }
                    }
...
static Value m_CEmitter_MethodSymbol_2_String(Value v_this, Value *args, int32_t count) {
    ...
    Value v_Symbol = alg_nil();
    (void)v_Symbol;
    (void)((v_Symbol = alg_add(alg_add(alg_add(alg_add(alg_add(alg_string("m_"), v_Owner), alg_char_value(95)), alg_str(alg_property(alg_property(v_TheMethod, "Name"), "Lexeme"))), alg_char_value(95)), alg_str(alg_property(alg_property(v_TheMethod, "Params"), "Length")))));
        ...
        while (alg_truthy(alg_less(v_I, alg_property(v_Types, "Length")))) {
            {
                if (alg_truthy(alg_not_equal(alg_subscript_get(v_Types, v_I), alg_string("Any")))) {
                    (void)((v_Symbol = alg_add(alg_add(v_Symbol, alg_char_value(95)), alg_str(alg_subscript_get(v_Types, v_I)))));
                }
                (void)((v_I = alg_add(v_I, alg_int(1))));
            }
        }
...
static Value m_CEmitter_EmitMethod_2_String(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_set_property(v_this, "Target", v_EnclosingTarget));
    (void)(alg_set_property(v_this, "Body", v_EnclosingBody));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("static Value ")), alg_invoke(v_this, "MethodSymbol", (Value[]){v_Owner, v_TheMethod}, 2)), alg_string("(Value v_this, Value *args, int32_t count) {")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("    (void)v_this; (void)args; (void)count;")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_property(v_this, "Functions"), v_Written)));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_add(alg_property(v_this, "Functions"), alg_char_value(125)), alg_char_value(10)), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Depth", v_EnclosingDepth));
    (void)(alg_set_property(v_this, "AtTopLevel", v_EnclosingTop));
    (void)(alg_set_property(v_this, "Locals", v_EnclosingLocals));
    (void)(alg_set_property(v_this, "Volatiles", v_EnclosingVolatiles));
...
static Value m_CEmitter_EmitClass_5_String_List_List_Boolean(Value v_this, Value *args, int32_t count) {
    ...
    (void)((v_Handle = alg_add(alg_string("k_"), v_Name)));
    ...
    Value v_AddId = (or_14 = v_IsObject, !alg_truthy(or_14) ? or_14 : alg_not(v_DeclaresId));
    (void)v_AddId;
    ...
    (void)((v_InitName = alg_add(alg_string("i_"), v_Name)));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("static Value ")), v_InitName), alg_string("(Value v_this, Value *args, int32_t count) {")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("    (void)v_this; (void)args; (void)count;")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_property(v_this, "Functions"), v_Applied)));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("    return alg_nil();")), alg_char_value(10)), alg_char_value(125)), alg_char_value(10)), alg_char_value(10))));
    {
        Value v_I = alg_int(0);
        (void)v_I;
    ...
    if (alg_truthy(alg_not_equal(v_SuperName, alg_string("")))) {
        (void)((v_SuperHandle = alg_add(alg_string("k_"), v_SuperName)));
    }
    (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    ")), v_Handle), alg_string(" = alg_class(")), f_QuoteC(NULL, (Value[]){v_Name}, 1)), alg_string(", ")), v_SuperHandle), alg_string(");")), alg_char_value(10))));
    {
        Value v_I = alg_int(0);
        (void)v_I;
        while (alg_truthy(alg_less(v_I, alg_property(v_Fields, "Length")))) {
            {
                (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    alg_class_field(")), v_Handle), alg_string(", ")), f_QuoteC(NULL, (Value[]){alg_str(alg_property(alg_property(alg_subscript_get(v_Fields, v_I), "Name"), "Lexeme"))}, 1)), alg_string(");")), alg_char_value(10))));
                (void)((v_I = alg_add(v_I, alg_int(1))));
            }
        }
    }
    if (alg_truthy(v_AddId)) {
        (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    alg_class_field(")), v_Handle), alg_string(", \"Id\");")), alg_char_value(10))));
    }
    (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    alg_class_initializer(")), v_Handle), alg_string(", ")), v_InitName), alg_string(");")), alg_char_value(10))));
    {
        Value v_I = alg_int(0);
        (void)v_I;
        while (alg_truthy(alg_less(v_I, alg_property(v_Methods, "Length")))) {
                    ...
                    if (alg_truthy(alg_greater(alg_property(v_Types, "Length"), alg_int(0)))) {
                        {
                            ...
                            (void)(alg_set_property(v_this, "Declarations", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Declarations"), alg_string("static const char *")), v_Table), alg_string("[] = { ")), v_Quoted), alg_string(" };")), alg_char_value(10))));
                        }
                    }
                    (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    alg_class_method(")), v_Handle), alg_string(", ")), f_QuoteC(NULL, (Value[]){alg_str(alg_property(alg_property(v_TheMethod, "Name"), "Lexeme"))}, 1)), alg_string(", ")), alg_invoke(v_this, "MethodSymbol", (Value[]){v_Name, v_TheMethod}, 2)), alg_string(", ")), alg_str(alg_property(alg_property(v_TheMethod, "Params"), "Length"))), alg_string(", ")), v_Table), alg_string(");")), alg_char_value(10))));
                }
                (void)((v_I = alg_add(v_I, alg_int(1))));
            }
        }
    ...
    if (alg_truthy(v_IsObject)) {
        (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    alg_class_is_object(")), v_Handle), alg_string(");")), alg_char_value(10))));
    }
    return alg_nil();
}
        ...
        if (alg_truthy(alg_invoke(alg_property(v_this, "Boxed"), "Contains", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1))) {
            {
                ...
                (void)(alg_invoke(v_this, "Line", (Value[]){alg_add(alg_add(alg_add(alg_add(v_Qualifier, alg_invoke(v_this, "Cell", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1)), alg_string(" = alg_cell(")), v_Value), alg_string(");"))}, 1));
                (void)(alg_invoke(v_this, "Line", (Value[]){alg_add(alg_add(alg_string("(void)"), alg_invoke(v_this, "Cell", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1)), alg_char_value(59))}, 1));
            }
        } else {
            {
                (void)(alg_invoke(alg_property(v_this, "Locals"), "Add", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1));
...
static Value m_CEmitter_VisitFunctionStmt_1_FunctionStmt(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_Nested;
    if (alg_truthy((or_15 = v_Nested, !alg_truthy(or_15) ? or_15 : alg_property(v_this, "InsideNested")))) {
        (void)(alg_invoke(v_this, "Unsupported", (Value[]){alg_string("A function nested more than one level deep")}, 1));
    }
    if (alg_truthy((or_16 = v_Nested, !alg_truthy(or_16) ? or_16 : alg_not_equal(alg_property(v_this, "CurrentClass"), alg_string(""))))) {
    ...
    if (alg_truthy(v_Nested)) {
        {
            ...
            (void)v_Index;
            {
                Value v_I = alg_int(0);
                (void)v_I;
                while (alg_truthy(alg_less(v_I, alg_property(v_EnclosingBoxed, "Length")))) {
                    {
                        (void)(alg_invoke(v_Index, "Put", (Value[]){alg_str(alg_subscript_get(v_EnclosingBoxed, v_I)), v_I}, 2));
                        (void)((v_I = alg_add(v_I, alg_int(1))));
                    }
                }
            }
    ...
    (void)(alg_set_property(v_this, "Target", v_EnclosingTarget));
    (void)(alg_set_property(v_this, "Body", v_EnclosingBody));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_add(alg_property(v_this, "Functions"), alg_invoke(v_this, "Prototype", (Value[]){v_TheStmt}, 1)), alg_string(" {")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_property(v_this, "Functions"), alg_string("    (void)cells; (void)args; (void)count;")), alg_char_value(10))));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_property(v_this, "Functions"), v_Written)));
    (void)(alg_set_property(v_this, "Functions", alg_add(alg_add(alg_add(alg_property(v_this, "Functions"), alg_char_value(125)), alg_char_value(10)), alg_char_value(10))));
    Value v_CapturedCells = v_EnclosingBoxed;
    ...
    if (alg_truthy(v_Nested)) {
    ...
    } else {
        {
            ...
            (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    ")), alg_invoke(v_this, "HandleName", (Value[]){v_Name}, 1)), alg_string(" = ")), alg_invoke(v_this, "ClosureOf", (Value[]){v_TheStmt, alg_list()}, 2)), alg_char_value(59)), alg_char_value(10))));
        }
    }
    return alg_nil();
}
...
static Value m_CEmitter_VisitVariableExpr_1_VariableExpr(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_17 = alg_invoke(alg_property(v_this, "Captured"), "Contains", (Value[]){v_Name}, 1), alg_truthy(or_17) ? or_17 : alg_invoke(alg_property(v_this, "Boxed"), "Contains", (Value[]){v_Name}, 1)))) {
        return alg_invoke(v_this, "Read", (Value[]){v_Name}, 1);
    }
    if (alg_truthy((or_19 = (or_18 = alg_not_equal(alg_property(v_this, "CurrentClass"), alg_string("")), !alg_truthy(or_18) ? or_18 : alg_not(alg_invoke(alg_property(v_this, "Locals"), "Contains", (Value[]){v_Name}, 1))), !alg_truthy(or_19) ? or_19 : alg_invoke(alg_property(v_this, "VisibleFields"), "Contains", (Value[]){v_Name}, 1)))) {
    ...
    if (alg_truthy(alg_not(alg_invoke(alg_property(v_this, "Locals"), "Contains", (Value[]){v_Name}, 1)))) {
        {
            ...
            if (alg_truthy(alg_invoke(alg_property(v_this, "EnumTypes"), "Contains", (Value[]){v_Name}, 1))) {
                return alg_add(alg_string("e_"), v_Name);
            }
            if (alg_truthy(alg_invoke(alg_property(v_this, "Objects"), "Contains", (Value[]){v_Name}, 1))) {
                return alg_add(alg_add(alg_string("alg_singleton(k_"), v_Name), alg_char_value(41));
            }
...
static Value m_CEmitter_VisitAssignExpr_1_AssignExpr(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_Name;
    (void)((v_Name = alg_str(alg_property(alg_property(v_TheExpr, "Name"), "Lexeme"))));
    if (alg_truthy((or_20 = alg_invoke(alg_property(v_this, "Captured"), "Contains", (Value[]){v_Name}, 1), alg_truthy(or_20) ? or_20 : alg_invoke(alg_property(v_this, "Boxed"), "Contains", (Value[]){v_Name}, 1)))) {
    ...
    if (alg_truthy((or_22 = (or_21 = alg_not_equal(alg_property(v_this, "CurrentClass"), alg_string("")), !alg_truthy(or_21) ? or_21 : alg_not(alg_invoke(alg_property(v_this, "Locals"), "Contains", (Value[]){v_Name}, 1))), !alg_truthy(or_22) ? or_22 : alg_invoke(alg_property(v_this, "VisibleFields"), "Contains", (Value[]){v_Name}, 1)))) {
...
static Value m_CEmitter_VisitCall_1_CallExpr(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_is(alg_property(v_TheExpr, "Callee"), "SuperExpr"))) {
        {
            ...
            return alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_string("alg_invoke_from(k_"), alg_property(v_this, "CurrentClass")), alg_string(", v_this, ")), f_QuoteC(NULL, (Value[]){alg_str(alg_property(alg_property(alg_property(v_TheExpr, "Callee"), "Method"), "Lexeme"))}, 1)), alg_string(", ")), alg_invoke(v_this, "ArgumentArray", (Value[]){v_Emitted}, 1)), alg_char_value(41));
        }
    }
    ...
    (void)v_Name;
    if (alg_truthy((or_24 = (or_23 = alg_invoke(alg_property(v_this, "Locals"), "Contains", (Value[]){v_Name}, 1), alg_truthy(or_23) ? or_23 : alg_invoke(alg_property(v_this, "Captured"), "Contains", (Value[]){v_Name}, 1)), alg_truthy(or_24) ? or_24 : alg_invoke(alg_property(v_this, "Boxed"), "Contains", (Value[]){v_Name}, 1)))) {
    ...
    if (alg_truthy(alg_not(alg_invoke(alg_property(v_this, "Locals"), "Contains", (Value[]){v_Name}, 1)))) {
        {
            if (alg_truthy((or_25 = alg_equal(v_Name, alg_string("List")), !alg_truthy(or_25) ? or_25 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
                return alg_string("alg_list()");
            }
            if (alg_truthy((or_26 = alg_equal(v_Name, alg_string("Map")), !alg_truthy(or_26) ? or_26 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
                return alg_string("alg_map()");
            }
            if (alg_truthy((or_27 = alg_equal(v_Name, alg_string("Stack")), !alg_truthy(or_27) ? or_27 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
                return alg_string("alg_stack()");
            }
            if (alg_truthy((or_28 = alg_equal(v_Name, alg_string("Set")), !alg_truthy(or_28) ? or_28 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
                return alg_string("alg_set()");
            }
            if (alg_truthy((or_29 = alg_equal(v_Name, alg_string("Set")), !alg_truthy(or_29) ? or_29 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(1))))) {
                return alg_add(alg_add(alg_string("alg_set_of("), v_Joined), alg_char_value(41));
            }
            if (alg_truthy((or_30 = alg_equal(v_Name, alg_string("Array")), !alg_truthy(or_30) ? or_30 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(1))))) {
                return alg_add(alg_add(alg_string("alg_array("), v_Joined), alg_char_value(41));
            }
            if (alg_truthy((or_31 = alg_equal(v_Name, alg_string("TextFile")), !alg_truthy(or_31) ? or_31 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
                return alg_string("alg_text_file()");
            }
        }
    }
    if (alg_truthy(alg_invoke(alg_property(v_this, "Classes"), "Contains", (Value[]){v_Name}, 1))) {
        return alg_add(alg_add(alg_add(alg_add(alg_string("alg_new(k_"), v_Name), alg_string(", ")), alg_invoke(v_this, "ArgumentArray", (Value[]){v_Arguments}, 1)), alg_char_value(41));
    }
    if (alg_truthy((or_33 = (or_32 = alg_not_equal(alg_property(v_this, "CurrentClass"), alg_string("")), !alg_truthy(or_32) ? or_32 : alg_not(alg_invoke(alg_property(v_this, "Declared"), "Contains", (Value[]){v_Name}, 1))), !alg_truthy(or_33) ? or_33 : alg_invoke(alg_property(v_this, "VisibleMethods"), "Contains", (Value[]){v_Name}, 1)))) {
...
static Value m_CEmitter_VisitLogical_1_LogicalExpr(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_set_property(v_this, "Declarations", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Declarations"), alg_string("static Value ")), v_Slot), alg_char_value(59)), alg_char_value(10))));
...
static Value m_CEmitter_VisitEnumStmt_1_EnumStmt(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_TheType;
    (void)((v_TheType = alg_add(alg_string("e_"), alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme")))));
    (void)(alg_invoke(v_this, "DeclareValue", (Value[]){v_TheType, alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 2));
    (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    ")), v_TheType), alg_string(" = alg_enum_type(")), f_QuoteC(NULL, (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1)), alg_string(");")), alg_char_value(10))));
    {
        Value v_I = alg_int(0);
        (void)v_I;
            ...
            {
                {
                    ...
                    (void)(alg_set_property(v_this, "Setup", alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Setup"), alg_string("    ")), v_Symbol), alg_string(" = alg_enum_member(")), v_TheType), alg_string(", ")), f_QuoteC(NULL, (Value[]){alg_str(alg_property(alg_subscript_get(alg_property(v_TheStmt, "Members"), v_I), "Lexeme"))}, 1)), alg_string(");")), alg_char_value(10))));
                }
                (void)((v_I = alg_add(v_I, alg_int(1))));
            }
        }
...
static Value m_CEmitter_VisitForInStmt_1_ForInStmt(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_set_property(v_this, "Depth", alg_add(alg_property(v_this, "Depth"), alg_int(1))));
    (void)(alg_invoke(alg_property(v_this, "Locals"), "Add", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1));
    (void)(alg_invoke(v_this, "Line", (Value[]){alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_invoke(v_this, "Local", NULL, 0), alg_invoke(v_this, "VariableName", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1)), alg_string(" = alg_iterable_at(")), v_Snapshot), alg_string(", ")), v_Index), alg_string(");"))}, 1));
    (void)(alg_invoke(v_this, "Line", (Value[]){alg_add(alg_add(alg_string("(void)"), alg_invoke(v_this, "VariableName", (Value[]){alg_str(alg_property(alg_property(v_TheStmt, "Name"), "Lexeme"))}, 1)), alg_char_value(59))}, 1));
    Value v_EnclosingLoopDepth = alg_property(v_this, "LoopTryDepth");
    (void)v_EnclosingLoopDepth;
    (void)(alg_set_property(v_this, "LoopTryDepth", alg_property(v_this, "TryDepth")));
...
static Value m_CEmitter_VisitVarGroupStmt_1_VarGroupStmt(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy(alg_property(v_this, "AtTopLevel"))) {
        {
            (void)(alg_set_property(v_this, "Declarations", alg_add(alg_add(alg_add(alg_add(alg_property(v_this, "Declarations"), alg_string("static Value ")), v_Shared), alg_char_value(59)), alg_char_value(10))));
                        ...
                        if (alg_truthy(alg_invoke(alg_property(v_this, "Boxed"), "Contains", (Value[]){v_Name}, 1))) {
                            {
                                ...
                                (void)(alg_invoke(v_this, "Line", (Value[]){alg_add(alg_add(alg_add(alg_add(v_Qualifier, alg_invoke(v_this, "Cell", (Value[]){v_Name}, 1)), alg_string(" = alg_cell(")), v_Shared), alg_string(");"))}, 1));
