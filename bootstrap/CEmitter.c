...
static Value m_CEmitter_RunsWhenTesting_1_Stmt(Value v_this, Value *args, int32_t count) {
    ...
    Value v_TheStmt = args[0];
    (void)v_TheStmt;
    return (or_15 = (or_14 = (or_13 = (or_12 = (or_11 = alg_is(v_TheStmt, "FunctionStmt"), alg_truthy(or_11) ? or_11 : alg_is(v_TheStmt, "ClassStmt")), alg_truthy(or_12) ? or_12 : alg_is(v_TheStmt, "ObjectStmt")), alg_truthy(or_13) ? or_13 : alg_is(v_TheStmt, "EnumStmt")), alg_truthy(or_14) ? or_14 : alg_is(v_TheStmt, "VarGroupStmt")), alg_truthy(or_15) ? or_15 : alg_is(v_TheStmt, "VarStmt"));
    return alg_nil();
}
...
static Value m_CEmitter_VisitAssignExpr_1_AssignExpr(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_40 = (or_39 = alg_not_equal(alg_property(v_this, "CurrentClass"), alg_string("")), !alg_truthy(or_39) ? or_39 : alg_not(alg_invoke(alg_property(v_this, "Locals"), "Contains", (Value[]){v_Name}, 1))), !alg_truthy(or_40) ? or_40 : alg_invoke(alg_property(v_this, "VisibleFields"), "Contains", (Value[]){v_Name}, 1)))) {
            ...
            {
                {
                    Value v_TheStmt = alg_subscript_get(alg_property(v_Unit, "Statements"), v_I);
                    (void)v_TheStmt;
                    if (alg_truthy((or_41 = alg_is(v_TheStmt, "FunctionStmt"), !alg_truthy(or_41) ? or_41 : alg_not(alg_invoke(v_this, "IsTest", (Value[]){v_TheStmt}, 1))))) {
...
static Value m_CEmitter_ConstructorFor_3_String_List_String(Value v_this, Value *args, int32_t count) {
    ...
    (void)v_Joined;
    if (alg_truthy((or_42 = alg_equal(v_Name, alg_string("List")), !alg_truthy(or_42) ? or_42 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
        return alg_string("alg_list()");
    }
    if (alg_truthy((or_43 = alg_equal(v_Name, alg_string("Map")), !alg_truthy(or_43) ? or_43 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
        return alg_string("alg_map()");
    }
    if (alg_truthy((or_44 = alg_equal(v_Name, alg_string("Stack")), !alg_truthy(or_44) ? or_44 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
        return alg_string("alg_stack()");
    }
    if (alg_truthy((or_45 = alg_equal(v_Name, alg_string("Set")), !alg_truthy(or_45) ? or_45 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
        return alg_string("alg_set()");
    }
    if (alg_truthy((or_46 = alg_equal(v_Name, alg_string("Set")), !alg_truthy(or_46) ? or_46 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(1))))) {
        return alg_add(alg_add(alg_string("alg_set_of("), v_Joined), alg_char_value(41));
    }
    if (alg_truthy((or_47 = alg_equal(v_Name, alg_string("Array")), !alg_truthy(or_47) ? or_47 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(1))))) {
        return alg_add(alg_add(alg_string("alg_array("), v_Joined), alg_char_value(41));
    }
    if (alg_truthy((or_48 = alg_equal(v_Name, alg_string("TextFile")), !alg_truthy(or_48) ? or_48 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
        return alg_string("alg_text_file()");
    }
    if (alg_truthy((or_49 = alg_equal(v_Name, alg_string("Buffer")), !alg_truthy(or_49) ? or_49 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(0))))) {
        return alg_string("alg_buffer(alg_int(0))");
    }
    if (alg_truthy((or_50 = alg_equal(v_Name, alg_string("Buffer")), !alg_truthy(or_50) ? or_50 : alg_equal(alg_property(v_Arguments, "Length"), alg_int(1))))) {
...
static Value m_CEmitter_VisitCall_1_CallExpr(Value v_this, Value *args, int32_t count) {
    ...
    if (alg_truthy((or_52 = alg_is(alg_property(v_TheExpr, "Callee"), "GetExpr"), !alg_truthy(or_52) ? or_52 : alg_not_equal(alg_property(alg_property(v_TheExpr, "Callee"), "Unit"), alg_string(""))))) {
        {
            Value v_Emitted = alg_list();
            (void)v_Emitted;
            {
    ...
    (void)v_Name;
    if (alg_truthy((or_54 = (or_53 = alg_invoke(alg_property(v_this, "Locals"), "Contains", (Value[]){v_Name}, 1), alg_truthy(or_53) ? or_53 : alg_invoke(alg_property(v_this, "Captured"), "Contains", (Value[]){v_Name}, 1)), alg_truthy(or_54) ? or_54 : alg_invoke(alg_property(v_this, "Boxed"), "Contains", (Value[]){v_Name}, 1)))) {
    ...
    if (alg_truthy((or_56 = (or_55 = alg_not_equal(alg_property(v_this, "CurrentClass"), alg_string("")), !alg_truthy(or_55) ? or_55 : alg_not(alg_invoke(alg_property(v_this, "Declared"), "Contains", (Value[]){v_Name}, 1))), !alg_truthy(or_56) ? or_56 : alg_invoke(alg_property(v_this, "VisibleMethods"), "Contains", (Value[]){v_Name}, 1)))) {
...
static Value m_CEmitter_UnitValue_2_String_String(Value v_this, Value *args, int32_t count) {
    ...
    Value v_Name = args[1];
    (void)v_Name;
    if (alg_truthy((or_57 = alg_invoke(alg_property(v_this, "UnitExports"), "Contains", (Value[]){v_Unit}, 1), !alg_truthy(or_57) ? or_57 : alg_not(alg_invoke((alg_invoke(alg_property(v_this, "UnitExports"), "Get", (Value[]){v_Unit}, 1)), "Contains", (Value[]){v_Name}, 1))))) {
        return alg_add(alg_add(alg_string("(alg_error("), f_QuoteC(NULL, (Value[]){alg_add(alg_add(alg_add(alg_add(alg_string("Undefined name '"), v_Name), alg_string("' in unit '")), v_Unit), alg_string("'."))}, 1)), alg_string("), alg_nil())"));
    }
    if (alg_truthy(alg_equal(v_Unit, alg_string("System")))) {
    ...
    if (alg_truthy(alg_not_equal(alg_property(v_TheExpr, "Unit"), alg_string("")))) {
        {
            ...
            (void)v_Name;
            if (alg_truthy((or_58 = alg_invoke(alg_property(v_this, "UnitExports"), "Contains", (Value[]){v_Unit}, 1), !alg_truthy(or_58) ? or_58 : alg_not(alg_invoke((alg_invoke(alg_property(v_this, "UnitExports"), "Get", (Value[]){v_Unit}, 1)), "Contains", (Value[]){v_Name}, 1))))) {
                return alg_add(alg_add(alg_string("(alg_error("), f_QuoteC(NULL, (Value[]){alg_add(alg_add(alg_add(alg_add(alg_string("Undefined name '"), v_Name), alg_string("' in unit '")), v_Unit), alg_string("'."))}, 1)), alg_string("), alg_nil())"));
            }
