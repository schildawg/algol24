...
static Value m_Console_Info_1_String(Value v_this, Value *args, int32_t count) {
    ...
    Value v_Text = args[0];
    (void)v_Text;
    (void)(alg_writeln(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(v_ANSI_WHITE, alg_char_value(91)), v_ANSI_BLUE), alg_string("INFO")), v_ANSI_WHITE), alg_string("] ")), v_ANSI_RESET), v_Text)));
    return alg_nil();
}
...
static Value m_Console_Error_2_Token_String(Value v_this, Value *args, int32_t count) {
    ...
    (void)(alg_writeln(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(v_ANSI_WHITE, alg_char_value(91)), v_ANSI_RED), alg_string("ERROR")), v_ANSI_WHITE), alg_string("] ")), v_ANSI_RESET), alg_invoke(alg_singleton(k_SourceCode), "Name", NULL, 0)), alg_string(": ")), v_Message)));
    (void)(alg_writeln(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(alg_add(v_ANSI_WHITE, alg_char_value(91)), v_ANSI_RED), alg_string("ERROR")), v_ANSI_WHITE), alg_string("] ")), v_ANSI_RESET), alg_str(alg_property(v_Where, "LineNumber"))), alg_string(" | ")), v_Text)));
