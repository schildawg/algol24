 ...
 *
 * Scope: this is the walking skeleton.  Integers, doubles, strings, booleans
 * and nil.  Doubles render in Algol-24's specified format -- shortest
 * round-trip -- which the interpreter's Numbers.java reproduces exactly.
 */
#ifndef ALGOL_H
#define ALGOL_H
...
typedef enum {
     ...
     * call.  The interpreter's PascalInstance.get hands back a bound method
     * for exactly this, and nothing here did. */
    OBJ_BOUND,
    OBJ_LIST,
    OBJ_SET,
    OBJ_STACK,
